...
void proba1_output(int_T tid)
{
...

  {
     ...
     */
    proba1_B.Compare_my = (proba1_B.DataStoreRead_b >= proba1_P.Constant_Value_d);
    ...
    proba1_B.LogicalOperator_ad = (proba1_B.Compare_my && proba1_B.Compare_dg);
     ...
     */
    proba1_B.Compare_cs = (proba1_B.DataStoreRead1 <= proba1_P.Constant_Value_e);

    /* Logic: '<S50>/Logical Operator' */
    proba1_B.LogicalOperator_o1 = (proba1_B.Compare_pa && proba1_B.Compare_cs);
    ...
    if (rtmIsMajorTimeStep(proba1_M) &&
      ...
      /* Outputs for enable and trigger SubSystem: '<S4>/jedz do przedmiotu' incorporates:
       *  Constant: '<S4>/przycisk jedz do przedmiotu'
       */
      if (proba1_B.Compare > 0U) {
        if (proba1_DWork.jedzdoprzedmiotu_MODE == SUBSYS_DISABLED) {
          proba1_DWork.jedzdoprzedmiotu_MODE = SUBSYS_ENABLED;
        }

        if (rtmIsMajorTimeStep(proba1_M) && (rt_ZCFcn(RISING_ZERO_CROSSING,
              &proba1_PrevZCSigState.jedzdoprzedmiotu_Trig_ZCE,
              (proba1_P.przyciskjedzdoprzedmiotu_Value)) != NO_ZCEVENT)) {
          /* DataStoreWrite: '<S100>/Data Store Write8' incorporates:
           *  Constant: '<S100>/Constant'
           */
          proba1_DWork.ready = proba1_P.Constant_Value_i4;

          /* DataStoreRead: '<S100>/Data Store Read' */
          proba1_B.DataStoreRead_d = proba1_DWork.obliczoneFi1;

          /* DataStoreWrite: '<S100>/Data Store Write' */
          proba1_DWork.tmp_u1 = proba1_B.DataStoreRead_d;

          /* DataStoreWrite: '<S100>/Data Store Write3' */
          proba1_DWork.u1 = proba1_B.DataStoreRead_d;

          /* DataStoreRead: '<S100>/Data Store Read1' */
          proba1_B.DataStoreRead1_e = proba1_DWork.obliczoneFi3;

          /* DataStoreWrite: '<S100>/Data Store Write2' */
          proba1_DWork.tmp_u3 = proba1_B.DataStoreRead1_e;

          /* DataStoreWrite: '<S100>/Data Store Write5' */
          proba1_DWork.u3 = proba1_B.DataStoreRead1_e;

          /* DataStoreRead: '<S100>/Data Store Read2' */
          proba1_B.DataStoreRead2_nt = proba1_DWork.obliczoneFi2;

          /* DataStoreWrite: '<S100>/Data Store Write1' */
          proba1_DWork.tmp_u2 = proba1_B.DataStoreRead2_nt;

          /* DataStoreWrite: '<S100>/Data Store Write4' */
          proba1_DWork.u2 = proba1_B.DataStoreRead2_nt;

          /* DataStoreRead: '<S100>/Data Store Read3' */
          proba1_B.DataStoreRead3_d = proba1_DWork.obliczoneDist;

          /* DataStoreWrite: '<S100>/Data Store Write6' */
          proba1_DWork.tmp_u0 = proba1_B.DataStoreRead3_d;

          /* DataStoreWrite: '<S100>/Data Store Write7' */
          proba1_DWork.u0 = proba1_B.DataStoreRead3_d;
        }
      } else if (proba1_DWork.jedzdoprzedmiotu_MODE == SUBSYS_ENABLED) {
        proba1_DWork.jedzdoprzedmiotu_MODE = SUBSYS_DISABLED;
      }

      proba1_PrevZCSigState.jedzdoprzedmiotu_Trig_ZCE =
        proba1_P.przyciskjedzdoprzedmiotu_Value < 0.0 ? NEG_ZCSIG :
        proba1_P.przyciskjedzdoprzedmiotu_Value > 0.0 ? POS_ZCSIG : ZERO_ZCSIG;
    ...
    if (proba1_DWork.kinematykaodwrotna_MODE == SUBSYS_ENABLED) {
      ...
      /* DataStoreRead: '<S119>/Data Store Read6' */
      proba1_B.DataStoreRead6_ob = proba1_DWork.yKon;

      /* DataStoreRead: '<S101>/Data Store Read2' */
      proba1_B.DataStoreRead2_k = proba1_DWork.zadaneY;

      /* Sum: '<S119>/Sum' */
      proba1_B.Sum_oi = proba1_B.DataStoreRead2_k - proba1_B.DataStoreRead6_ob;
      ...
      /* Outputs for atomic SubSystem: '<S119>/warunek na Fi' */

      /* Switch: '<S125>/Switch1' incorporates:
       *  Constant: '<S125>/FImax'
       *  Constant: '<S125>/FImin1'
       */
      ...
      proba1_B.Xgran_k = tmp * tan(tmp_1);
      ...
      /* DataStoreRead: '<S127>/Data Store Read6' */
       ...
       */
      proba1_B.Compare_ns = (proba1_B.Add_oq > proba1_P.Constant_Value_dg);
      ...
      proba1_B.LogicalOperator4_j = ((proba1_B.Compare_ns != 0U) &&
      ...
      proba1_B.LogicalOperator4_k5 = ((proba1_B.Compare_bm != 0U) &&
        (proba1_B.Compare_im != 0U));

      /* Switch: '<S125>/Switch4' */
      if (proba1_B.LogicalOperator4_k5) {
        proba1_B.Switch4_g = proba1_B.Xnastawy1_n;
      } else {
        /* Switch: '<S125>/Switch5' incorporates:
         *  Constant: '<S125>/nieosiagalna'
         */
      ...
      /* end of Outputs for SubSystem: '<S119>/warunek na Fi' */

      /* RelationalOperator: '<S122>/Compare' incorporates:
       *  Constant: '<S122>/Constant'
       */
      proba1_B.Compare_j = (proba1_B.fi_n <= proba1_P.Constant_Value_kv);

      /* Logic: '<S119>/Logical Operator1' */
      proba1_B.LogicalOperator1_eq = ((proba1_B.Compare_bb != 0U) ||
        (proba1_B.Compare_j != 0U));

      /* RelationalOperator: '<S123>/Compare' incorporates:
       *  Constant: '<S123>/Constant'
       */
      proba1_B.Compare_l = (proba1_B.Switch1_g >= proba1_P.Constant_Value_i4n);
      ...
      /* Outputs for atomic SubSystem: '<S119>/warunek na R' */
      ...
      proba1_B.fi_kl = acos(tmp / tmp_1) * rt_SGN(tmp_0);

      /* Gain: '<S126>/Gain' */
      tmp = proba1_B.Switch1_na;
      tmp_0 = proba1_B.fi_kl;
      ...
      /* Gain: '<S135>/Gain' */
      proba1_B.Gain_i = proba1_P.Gain_Gain_gw * proba1_B.Xgran1_b;

      /* DataStoreRead: '<S133>/Data Store Read6' */
      proba1_B.DataStoreRead6_kz = proba1_DWork.yKon;

      /* Sum: '<S133>/Add' */
      proba1_B.Add_hm = proba1_B.Gain_i + proba1_B.DataStoreRead6_kz;

      /* RelationalOperator: '<S138>/Compare' incorporates:
       *  Constant: '<S138>/Constant'
       */
      proba1_B.Compare_lx = (proba1_B.Add_hm > proba1_P.Constant_Value_bb);

      /* RelationalOperator: '<S137>/Compare' incorporates:
       *  Constant: '<S137>/Constant'
       */
      proba1_B.Compare_i = (proba1_B.Add_hm < proba1_P.Constant_Value_ih);

      /* Logic: '<S133>/Logical Operator4' */
      proba1_B.LogicalOperator4_p = ((proba1_B.Compare_lx != 0U) &&
        (proba1_B.Compare_i != 0U));

      /* Fcn: '<S134>/Xgran' */
      tmp = proba1_B.Switch1_na;
      tmp_0 = proba1_B.fi_kl;
      proba1_B.Xgran_df = tmp * sin(tmp_0);

      /* Fcn: '<S134>/Xgran1' */
      tmp_0 = proba1_B.Sum_oi;
      tmp_1 = proba1_B.Xgran_df;
       ...
       */
      proba1_B.Compare_a = (proba1_B.fi_kl <= proba1_P.Constant_Value_av);

      /* RelationalOperator: '<S140>/Compare' incorporates:
       *  Constant: '<S140>/Constant'
       */
      proba1_B.Compare_f5 = (proba1_B.fi_kl >= proba1_P.Constant_Value_k4);

      /* Logic: '<S134>/Logical Operator1' */
      proba1_B.LogicalOperator1_j = ((proba1_B.Compare_a != 0U) &&
      ...
      /* DataStoreRead: '<S136>/Data Store Read6' */
      ...
      if (proba1_B.LogicalOperator4_a) {
        ...
        if (proba1_B.LogicalOperator4_p) {
          proba1_B.Switch5_k = proba1_B.Gain_i;
        } else {
      ...
      /* end of Outputs for SubSystem: '<S119>/warunek na R' */

      /* Logic: '<S119>/Logical Operator3' */
      proba1_B.LogicalOperator3_f = (proba1_B.LogicalOperator1_eq &&
      ...
      if (proba1_B.not1_h) {
        /* Switch: '<S119>/Switch5' */
        if (proba1_B.LogicalOperator1_eq) {
      ...
      /* Sum: '<S101>/Add2' */
      proba1_B.Add2_o = proba1_B.DataStoreRead6_j + proba1_B.Switch2_n;
      ...
      tmp = proba1_B.DataStoreRead_h;
      tmp_0 = proba1_B.Add1_n;
      tmp_2 = proba1_B.DataStoreRead1_jb;
      tmp_1 = proba1_B.fi1_g;
      proba1_B.fi2_b = (1.57075 - rt_atan2(tmp_2 - 700.0, sqrt(pow(tmp - 250.0 *
        cos(tmp_1), 2.0) + pow(tmp_0 - 250.0 * sin(tmp_1), 2.0)))) - acos
        (((((pow(tmp - 250.0 * cos(tmp_1), 2.0) + pow(450.0, 2.0)) + pow(tmp_0 -
             250.0 * sin(tmp_1), 2.0)) + pow(tmp_2 - 700.0, 2.0)) - pow(670.0,
           2.0)) / (sqrt((pow(tmp - 250.0 * cos(tmp_1), 2.0) + pow(tmp_0 - 250.0
             * sin(tmp_1), 2.0)) + pow(tmp_2 - 700.0, 2.0)) * 900.0));
      ...
      proba1_B.fi3_a = asin(((450.0 * cos(tmp_1) - tmp_2) + 700.0) / 670.0);
       ...
       */
      proba1_B.Compare_fra = (proba1_B.Gain_a0 >= proba1_P.Constant_Value_bw);
      ...
      proba1_B.LogicalOperator_nh = (proba1_B.Compare_kr && proba1_B.Compare_km &&
        proba1_B.Compare_mr && proba1_B.Compare_fra && proba1_B.Compare_jp &&
      ...
      if (proba1_DWork.podajwyliczonewartosci_MODE == SUBSYS_ENABLED) {
        ...
        /* DataStoreWrite: '<S120>/Data Store Write3' */
    ...
    if (rtmIsMajorTimeStep(proba1_M) &&
      ...
      if (rtmIsMajorTimeStep(proba1_M) &&
        ...
        if (proba1_DWork.rozpoznawanieobrazu_MODE == SUBSYS_ENABLED) {
          ...
          /* DataStoreRead: '<S158>/Data Store Read6' */
          proba1_B.DataStoreRead6_g = proba1_DWork.yKon;

          /* Sum: '<S158>/Sum' incorporates:
           *  Constant: '<S102>/obliczoneY'
           */
          proba1_B.Sum_n = proba1_P.obliczoneY_Value - proba1_B.DataStoreRead6_g;

          /* Fcn: '<S158>/r' incorporates:
           *  Constant: '<S102>/obliczoneX'
           *  Constant: '<S102>/obliczoneZ'
           */
          tmp = proba1_P.obliczoneX_Value;
          tmp_0 = proba1_B.Sum_n;
          ...
          if (proba1_B.r != 0.0) {
            ...
            proba1_B.Switch1 = proba1_P.Constant1_Value_c;
          }

          /* Fcn: '<S158>/fi' incorporates:
           *  Constant: '<S102>/obliczoneX'
           *  Constant: '<S102>/obliczoneZ'
           */
          tmp = proba1_P.obliczoneX_Value;
           ...
           */
          proba1_B.Compare_k = (proba1_B.fi >= proba1_P.Constant_Value_oq);

          /* Outputs for atomic SubSystem: '<S158>/warunek na Fi' */

          /* Switch: '<S164>/Switch1' incorporates:
           *  Constant: '<S164>/FImax'
           *  Constant: '<S164>/FImin1'
           */
          if (proba1_B.Compare_k != 0U) {
            proba1_B.Switch1_n = proba1_P.FImax_Value_m;
          } else {
            proba1_B.Switch1_n = proba1_P.FImin1_Value_h;
          }

          /* Fcn: '<S164>/Xgran' incorporates:
           *  Constant: '<S102>/obliczoneX'
           *  Constant: '<S102>/obliczoneZ'
           */
          tmp = proba1_P.obliczoneX_Value;
          tmp_1 = proba1_B.Switch1_n;
          proba1_B.Xgran_g = tmp * tan(tmp_1);

          /* Fcn: '<S164>/Xnastawy2' incorporates:
           *  Constant: '<S102>/obliczoneX'
           *  Constant: '<S102>/obliczoneZ'
           */
          tmp_0 = proba1_B.Sum_n;
          tmp_1 = proba1_B.Xgran_g;
          proba1_B.Xnastawy2 = tmp_0 + tmp_1;

          /* DataStoreRead: '<S166>/Data Store Read6' */
          proba1_B.DataStoreRead6_c = proba1_DWork.yKon;

          /* Sum: '<S166>/Add' */
          proba1_B.Add_h = proba1_B.Xnastawy2 + proba1_B.DataStoreRead6_c;

          /* RelationalOperator: '<S169>/Compare' incorporates:
           *  Constant: '<S169>/Constant'
           */
          proba1_B.Compare_m = (proba1_B.Add_h > proba1_P.Constant_Value_ec);

          /* RelationalOperator: '<S168>/Compare' incorporates:
           *  Constant: '<S168>/Constant'
           */
          proba1_B.Compare_o = (proba1_B.Add_h < proba1_P.Constant_Value_f4);

          /* Logic: '<S166>/Logical Operator4' */
          proba1_B.LogicalOperator4_k = ((proba1_B.Compare_m != 0U) &&
            (proba1_B.Compare_o != 0U));

          /* Fcn: '<S164>/Xnastawy1' incorporates:
           *  Constant: '<S102>/obliczoneX'
           *  Constant: '<S102>/obliczoneZ'
           */
          tmp_0 = proba1_B.Sum_n;
          ...
          /* Sum: '<S167>/Add' */
          proba1_B.Add_k = proba1_B.Xnastawy1 + proba1_B.DataStoreRead6_k;

          /* RelationalOperator: '<S171>/Compare' incorporates:
           *  Constant: '<S171>/Constant'
           */
          proba1_B.Compare_bq = (proba1_B.Add_k > proba1_P.Constant_Value_pd);

          /* RelationalOperator: '<S170>/Compare' incorporates:
           *  Constant: '<S170>/Constant'
           */
          proba1_B.Compare_fd = (proba1_B.Add_k < proba1_P.Constant_Value_d0);

          /* Logic: '<S167>/Logical Operator4' */
          proba1_B.LogicalOperator4_g = ((proba1_B.Compare_bq != 0U) &&
            (proba1_B.Compare_fd != 0U));

          /* Switch: '<S164>/Switch4' */
          if (proba1_B.LogicalOperator4_g) {
            proba1_B.Switch4_o = proba1_B.Xnastawy1;
          } else {
            /* Switch: '<S164>/Switch5' incorporates:
             *  Constant: '<S164>/nieosiagalna'
             */
            if (proba1_B.LogicalOperator4_k) {
              proba1_B.Switch5_e = proba1_B.Xnastawy2;
            } else {
              proba1_B.Switch5_e = proba1_P.nieosiagalna_Value_p;
            }

            proba1_B.Switch4_o = proba1_B.Switch5_e;
          }

          /* end of Outputs for SubSystem: '<S158>/warunek na Fi' */

          /* RelationalOperator: '<S161>/Compare' incorporates:
           *  Constant: '<S161>/Constant'
           */
          proba1_B.Compare_gq = (proba1_B.fi <= proba1_P.Constant_Value_mk);

          /* Logic: '<S158>/Logical Operator1' */
          proba1_B.LogicalOperator1 = ((proba1_B.Compare_k != 0U) ||
            (proba1_B.Compare_gq != 0U));

          /* RelationalOperator: '<S162>/Compare' incorporates:
           *  Constant: '<S162>/Constant'
           */
          proba1_B.Compare_ku = (proba1_B.Switch1 >= proba1_P.Constant_Value_m1);

          /* RelationalOperator: '<S163>/Compare' incorporates:
           *  Constant: '<S163>/Constant'
           */
          proba1_B.Compare_f = (proba1_B.Switch1 <= proba1_P.Constant_Value_gh);

          /* Logic: '<S158>/Logical Operator2' */
          proba1_B.LogicalOperator2 = ((proba1_B.Compare_ku != 0U) ||
            (proba1_B.Compare_f != 0U));

          /* Outputs for atomic SubSystem: '<S158>/warunek na R' */

          /* Switch: '<S165>/Switch1' incorporates:
           *  Constant: '<S165>/Rmax'
           *  Constant: '<S165>/Rmin'
           */
          if (proba1_B.Compare_f != 0U) {
            proba1_B.Switch1_h = proba1_P.Rmin_Value_f;
          } else {
            proba1_B.Switch1_h = proba1_P.Rmax_Value_f;
          }

          /* Fcn: '<S165>/fi' incorporates:
           *  Constant: '<S102>/obliczoneX'
           *  Constant: '<S102>/obliczoneZ'
           */
          tmp = proba1_P.obliczoneX_Value;
          tmp_0 = proba1_B.Sum_n;
          tmp_1 = proba1_B.Switch1_h;
          proba1_B.fi_k = acos(tmp / tmp_1) * rt_SGN(tmp_0);

          /* Gain: '<S165>/Gain' */
          tmp = proba1_B.Switch1_h;
          tmp_0 = proba1_B.fi_k;
          proba1_B.Gain_l[0] = proba1_P.Gain_Gain_kh * tmp;
          proba1_B.Gain_l[1] = proba1_P.Gain_Gain_kh * tmp_0;

          /* Fcn: '<S174>/Xgran' */
          proba1_B.Xgran = (-proba1_B.Gain_l[0]) * sin(proba1_B.Gain_l[1]);

          /* Fcn: '<S174>/Xgran1' incorporates:
           *  Constant: '<S102>/obliczoneX'
           *  Constant: '<S102>/obliczoneZ'
           */
          tmp_0 = proba1_B.Sum_n;
          ...
          /* Gain: '<S174>/Gain' */
          proba1_B.Gain_d = proba1_P.Gain_Gain_l * proba1_B.Xgran1;

          /* DataStoreRead: '<S172>/Data Store Read6' */
          proba1_B.DataStoreRead6_i = proba1_DWork.yKon;

          /* Sum: '<S172>/Add' */
          proba1_B.Add_l = proba1_B.Gain_d + proba1_B.DataStoreRead6_i;

          /* RelationalOperator: '<S177>/Compare' incorporates:
           *  Constant: '<S177>/Constant'
           */
          proba1_B.Compare_c = (proba1_B.Add_l > proba1_P.Constant_Value_co);

          /* RelationalOperator: '<S176>/Compare' incorporates:
           *  Constant: '<S176>/Constant'
           */
          proba1_B.Compare_b = (proba1_B.Add_l < proba1_P.Constant_Value_bs);

          /* Logic: '<S172>/Logical Operator4' */
          proba1_B.LogicalOperator4 = ((proba1_B.Compare_c != 0U) &&
          ...
          /* Fcn: '<S173>/Xgran1' incorporates:
           *  Constant: '<S102>/obliczoneX'
           *  Constant: '<S102>/obliczoneZ'
           */
          tmp_0 = proba1_B.Sum_n;
          tmp_1 = proba1_B.Xgran_d;
          proba1_B.Xgran1_o = tmp_1 - tmp_0;

          /* Gain: '<S173>/Gain' */
          proba1_B.Gain_m = proba1_P.Gain_Gain_fr * proba1_B.Xgran1_o;

          /* RelationalOperator: '<S178>/Compare' incorporates:
           *  Constant: '<S178>/Constant'
           */
          proba1_B.Compare_h = (proba1_B.fi_k <= proba1_P.Constant_Value_be);

          /* RelationalOperator: '<S179>/Compare' incorporates:
           *  Constant: '<S179>/Constant'
           */
          proba1_B.Compare_n = (proba1_B.fi_k >= proba1_P.Constant_Value_bn);

          /* Logic: '<S173>/Logical Operator1' */
          proba1_B.LogicalOperator1_l = ((proba1_B.Compare_h != 0U) &&
            (proba1_B.Compare_n != 0U));

          /* RelationalOperator: '<S180>/Compare' incorporates:
           *  Constant: '<S180>/Constant'
           */
          tmp = proba1_B.Gain_l[1];
          proba1_B.Compare_d = (tmp <= proba1_P.Constant_Value_eg);

          /* RelationalOperator: '<S181>/Compare' incorporates:
           *  Constant: '<S181>/Constant'
           */
          tmp = proba1_B.Gain_l[1];
          proba1_B.Compare_fr = (tmp >= proba1_P.Constant_Value_nq);

          /* Logic: '<S174>/Logical Operator1' */
          proba1_B.LogicalOperator1_e = ((proba1_B.Compare_d != 0U) &&
            (proba1_B.Compare_fr != 0U));

          /* DataStoreRead: '<S175>/Data Store Read6' */
          proba1_B.DataStoreRead6_o = proba1_DWork.yKon;

          /* Sum: '<S175>/Add' */
          proba1_B.Add_m = proba1_B.Gain_m + proba1_B.DataStoreRead6_o;

          /* RelationalOperator: '<S183>/Compare' incorporates:
           *  Constant: '<S183>/Constant'
           */
          proba1_B.Compare_fq = (proba1_B.Add_m > proba1_P.Constant_Value_bt);

          /* RelationalOperator: '<S182>/Compare' incorporates:
           *  Constant: '<S182>/Constant'
           */
          proba1_B.Compare_fs = (proba1_B.Add_m < proba1_P.Constant_Value_lw);

          /* Logic: '<S175>/Logical Operator4' */
          proba1_B.LogicalOperator4_h = ((proba1_B.Compare_fq != 0U) &&
            (proba1_B.Compare_fs != 0U));

          /* Switch: '<S165>/Switch4' */
          if (proba1_B.LogicalOperator4_h) {
            proba1_B.Switch4 = proba1_B.Gain_m;
          } else {
            /* Switch: '<S165>/Switch5' incorporates:
             *  Constant: '<S165>/nieosiagalna'
             */
            if (proba1_B.LogicalOperator4) {
              proba1_B.Switch5 = proba1_B.Gain_d;
            } else {
              proba1_B.Switch5 = proba1_P.nieosiagalna_Value_l;
            }
          ...
          if (proba1_B.LogicalOperator4_h) {
             ...
             *  Constant: '<S165>/nieosiagalna1'
             */
            if (proba1_B.LogicalOperator4) {
              proba1_B.Switch2_d = (real_T)proba1_B.LogicalOperator1_e;
            } else {
              proba1_B.Switch2_d = proba1_P.nieosiagalna1_Value_k;
            }

            proba1_B.Switch6 = proba1_B.Switch2_d;
          }

          /* end of Outputs for SubSystem: '<S158>/warunek na R' */
          ...
          if (proba1_B.not1) {
            ...
            if (proba1_B.LogicalOperator1) {
               ...
               */
              if (proba1_B.LogicalOperator1) {
                proba1_B.Switch3 = proba1_B.Switch4_o;
              } else {
                proba1_B.Switch3 = proba1_P.u_Value_m;
              }

              proba1_B.Switch5_a = proba1_B.Switch3;
            } else {
              /* Logic: '<S158>/not' */
               ...
               */
              if (proba1_B.not) {
                proba1_B.Switch4_a = proba1_P._Value_f;
              } else {
                proba1_B.Switch4_a = proba1_B.Switch4;
              }

              proba1_B.Switch5_a = proba1_B.Switch4_a;
            }

            proba1_B.Switch2 = proba1_B.Switch5_a;
          } else {
            /* Switch: '<S158>/Switch6' */
            if (proba1_B.Switch6 != 0.0) {
              proba1_B.Switch6_i = proba1_B.Switch4;
            } else {
              proba1_B.Switch6_i = proba1_B.Switch4_o;
            }

            proba1_B.Switch2 = proba1_B.Switch6_i;
          }
           ...
           *  Constant: '<S102>/obliczoneY'
           */
          proba1_B.Add1 = proba1_P.obliczoneY_Value - proba1_B.Add2;

          /* Fcn: '<S102>/fi1' incorporates:
           *  Constant: '<S102>/obliczoneX'
           *  Constant: '<S102>/obliczoneZ'
           */
          tmp = proba1_P.obliczoneX_Value;
          ...
          /* Gain: '<S155>/Gain' */
          proba1_B.Gain_a = proba1_P.Gain_Gain_l0 * proba1_B.fi1;

          /* Fcn: '<S102>/fi2' incorporates:
           *  Constant: '<S102>/obliczoneX'
           *  Constant: '<S102>/obliczoneZ'
           */
          tmp = proba1_P.obliczoneX_Value;
          tmp_0 = proba1_B.Add1;
          tmp_2 = proba1_P.obliczoneZ_Value;
          tmp_1 = proba1_B.fi1;
          proba1_B.fi2 = (1.57075 - rt_atan2(tmp_2 - 700.0, sqrt(pow(tmp - 250.0
            * cos(tmp_1), 2.0) + pow(tmp_0 - 250.0 * sin(tmp_1), 2.0)))) - acos
            (((((pow(tmp - 250.0 * cos(tmp_1), 2.0) + pow(450.0, 2.0)) + pow
                (tmp_0 - 250.0 * sin(tmp_1), 2.0)) + pow(tmp_2 - 700.0, 2.0)) -
              pow(670.0, 2.0)) / (sqrt((pow(tmp - 250.0 * cos(tmp_1), 2.0) + pow
                (tmp_0 - 250.0 * sin(tmp_1), 2.0)) + pow(tmp_2 - 700.0, 2.0)) *
              900.0));

          /* Gain: '<S156>/Gain' */
          proba1_B.Gain_n = proba1_P.Gain_Gain_fi * proba1_B.fi2;

          /* Fcn: '<S102>/fi3' incorporates:
           *  Constant: '<S102>/obliczoneX'
           *  Constant: '<S102>/obliczoneZ'
           */
          tmp_2 = proba1_P.obliczoneZ_Value;
          tmp_1 = proba1_B.fi2;
          proba1_B.fi3 = asin(((450.0 * cos(tmp_1) - tmp_2) + 700.0) / 670.0);

          /* Gain: '<S157>/Gain' */
          proba1_B.Gain_k2 = proba1_P.Gain_Gain_kc * proba1_B.fi3;

          /* RelationalOperator: '<S153>/Compare' incorporates:
           *  Constant: '<S102>/obliczoneX'
           *  Constant: '<S153>/Constant'
           */
          proba1_B.Compare_ni = (proba1_P.obliczoneX_Value >=
            proba1_P.Constant_Value_jt);

          /* RelationalOperator: '<S154>/Compare' incorporates:
           *  Constant: '<S102>/obliczoneX'
           *  Constant: '<S154>/Constant'
           */
          proba1_B.Compare_pz = (proba1_P.obliczoneX_Value <=
            proba1_P.Constant_Value_kd);

          /* Fcn: '<S102>/ograniczenie' incorporates:
           *  Constant: '<S102>/obliczoneX'
           *  Constant: '<S102>/obliczoneZ'
           */
          tmp = proba1_P.obliczoneX_Value;
          tmp_0 = proba1_B.Add1;
          tmp_1 = proba1_P.obliczoneZ_Value;
           ...
           */
          proba1_B.Compare_kl = (proba1_B.ograniczenie <=
            proba1_P.Constant_Value_l2);

          /* RelationalOperator: '<S146>/Compare' incorporates:
           *  Constant: '<S146>/Constant'
           */
          proba1_B.Compare_jh = (proba1_B.Gain_a >= proba1_P.Constant_Value_al);

          /* RelationalOperator: '<S147>/Compare' incorporates:
           *  Constant: '<S147>/Constant'
           */
          proba1_B.Compare_is = (proba1_B.Gain_a <= proba1_P.Constant_Value_dg1);

          /* RelationalOperator: '<S148>/Compare' incorporates:
           *  Constant: '<S148>/Constant'
           */
          proba1_B.Compare_dq = (proba1_B.Gain_n >= proba1_P.Constant_Value_on0);

          /* RelationalOperator: '<S149>/Compare' incorporates:
           *  Constant: '<S149>/Constant'
           */
          proba1_B.Compare_j5 = (proba1_B.Gain_n <= proba1_P.Constant_Value_h3);

          /* RelationalOperator: '<S150>/Compare' incorporates:
           *  Constant: '<S150>/Constant'
           */
          proba1_B.Compare_mk = (proba1_B.Gain_k2 >= proba1_P.Constant_Value_hi);

          /* RelationalOperator: '<S151>/Compare' incorporates:
           *  Constant: '<S151>/Constant'
           */
          proba1_B.Compare_nv = (proba1_B.Gain_k2 <= proba1_P.Constant_Value_lv);

          /* Sum: '<S102>/Add' */
          proba1_B.Add = proba1_B.Gain_n - proba1_B.Gain_k2;

          /* Abs: '<S102>/Abs' */
          proba1_B.Abs_k = fabs(proba1_B.Add);

          /* RelationalOperator: '<S152>/Compare' incorporates:
           *  Constant: '<S152>/Constant'
           */
          proba1_B.Compare_mo = (proba1_B.Abs_k <= proba1_P.Constant_Value_iw);

          /* Logic: '<S102>/Logical Operator' */
          proba1_B.LogicalOperator_d = (proba1_B.Compare_ni &&
            proba1_B.Compare_pz && proba1_B.Compare_kl && proba1_B.Compare_jh &&
            proba1_B.Compare_is && proba1_B.Compare_dq && proba1_B.Compare_j5 &&
            proba1_B.Compare_mk && proba1_B.Compare_nv && proba1_B.Compare_mo);

          /* Outputs for enable SubSystem: '<S102>/podaj wyliczone wartosci' */
          if (proba1_B.LogicalOperator_d) {
            /* DataStoreWrite: '<S159>/Data Store Write' */
            proba1_DWork.obliczoneFi1 = proba1_B.Gain_a;

            /* DataStoreWrite: '<S159>/Data Store Write1' */
            proba1_DWork.obliczoneFi2 = proba1_B.Gain_n;

            /* DataStoreWrite: '<S159>/Data Store Write2' */
            proba1_DWork.obliczoneFi3 = proba1_B.Gain_k2;

            /* DataStoreWrite: '<S159>/Data Store Write3' */
      ...
      if (rtmIsMajorTimeStep(proba1_M) &&
        ...
        if (proba1_DWork.trybciagly_MODE == SUBSYS_ENABLED) {
          ...
          /* DataStoreWrite: '<S103>/Data Store Write2' */
          ...
          /* DataStoreRead: '<S103>/Data Store Read3' */
          proba1_B.DataStoreRead3_n = proba1_DWork.tmp_u0;

          /* DataStoreWrite: '<S103>/Data Store Write3' */
          ...
          /* DataStoreWrite: '<S103>/Data Store Write4' */
          ...
          /* DataStoreWrite: '<S103>/Data Store Write5' */
      ...
      /* Outputs for enable and trigger SubSystem: '<S4>/tryb kinematyki odwrotnej' incorporates:
       *  Constant: '<S4>/przycisk wyzwolenia'
       */
      if (proba1_B.Compare_p > 0U) {
        if (proba1_DWork.trybkinematykiodwrotnej_MODE == SUBSYS_DISABLED) {
          proba1_DWork.trybkinematykiodwrotnej_MODE = SUBSYS_ENABLED;
        }

        if (rtmIsMajorTimeStep(proba1_M) && (rt_ZCFcn(RISING_ZERO_CROSSING,
              &proba1_PrevZCSigState.trybkinematykiodwrotnej_Trig_ZC,
              (proba1_P.przyciskwyzwolenia_Value)) != NO_ZCEVENT)) {
          /* DataStoreRead: '<S104>/Data Store Read' */
          proba1_B.DataStoreRead_b5 = proba1_DWork.obliczoneFi1;

          /* DataStoreWrite: '<S104>/Data Store Write' */
          proba1_DWork.tmp_u1 = proba1_B.DataStoreRead_b5;

          /* DataStoreWrite: '<S104>/Data Store Write3' */
          proba1_DWork.u1 = proba1_B.DataStoreRead_b5;

          /* DataStoreRead: '<S104>/Data Store Read1' */
          proba1_B.DataStoreRead1_f = proba1_DWork.obliczoneFi3;

          /* DataStoreWrite: '<S104>/Data Store Write2' */
          proba1_DWork.tmp_u3 = proba1_B.DataStoreRead1_f;

          /* DataStoreWrite: '<S104>/Data Store Write5' */
          proba1_DWork.u3 = proba1_B.DataStoreRead1_f;

          /* DataStoreRead: '<S104>/Data Store Read2' */
          proba1_B.DataStoreRead2_n = proba1_DWork.obliczoneFi2;

          /* DataStoreWrite: '<S104>/Data Store Write1' */
          proba1_DWork.tmp_u2 = proba1_B.DataStoreRead2_n;

          /* DataStoreWrite: '<S104>/Data Store Write4' */
          proba1_DWork.u2 = proba1_B.DataStoreRead2_n;

          /* DataStoreRead: '<S104>/Data Store Read3' */
          proba1_B.DataStoreRead3_b = proba1_DWork.obliczoneDist;

          /* DataStoreWrite: '<S104>/Data Store Write6' */
          proba1_DWork.tmp_u0 = proba1_B.DataStoreRead3_b;

          /* DataStoreWrite: '<S104>/Data Store Write7' */
          proba1_DWork.u0 = proba1_B.DataStoreRead3_b;
        }
      } else if (proba1_DWork.trybkinematykiodwrotnej_MODE == SUBSYS_ENABLED) {
        proba1_DWork.trybkinematykiodwrotnej_MODE = SUBSYS_DISABLED;
      }
      ...
      if (proba1_B.Compare_gt > 0U) {
        ...
        if (rtmIsMajorTimeStep(proba1_M) && (rt_ZCFcn(RISING_ZERO_CROSSING,
          ...
          /* DataStoreWrite: '<S105>/Data Store Write2' */
...
void proba1_initialize(boolean_T firstTime)
{
  ...
  proba1_PrevZCSigState.trybkinematykiodwrotnej_Trig_ZC = UNINITIALIZED_ZCSIG;
  proba1_PrevZCSigState.jedzdoprzedmiotu_Trig_ZCE = UNINITIALIZED_ZCSIG;
...
void MdlInitializeSizes(void)
{
  ...
  proba1_M->Sizes.numBlocks = (668);   /* Number of blocks */
  proba1_M->Sizes.numBlockIO = (399);  /* Number of block outputs */
  proba1_M->Sizes.numBlockPrms = (379);/* Sum of parameter "widths" */
}
...
void MdlStart(void)
{
  ...
  /* Start for DataStoreMemory: '<Root>/Rmax' */
  proba1_DWork.Rmax = proba1_P.Rmax_InitialValue;

  /* Start for DataStoreMemory: '<Root>/Rmin' */
  proba1_DWork.Rmin = proba1_P.Rmin_InitialValue;
  ...
  /* Start for DataStoreMemory: '<Root>/ready' */
  proba1_DWork.ready = proba1_P.ready_InitialValue;
