 ...
 * C source code generated on : Fri Jul 04 13:06:39 2014
 */
...
typedef struct {
  ...
  real_T DataStoreRead_b5;             /* '<S104>/Data Store Read' */
  real_T DataStoreRead1_f;             /* '<S104>/Data Store Read1' */
  real_T DataStoreRead2_n;             /* '<S104>/Data Store Read2' */
  real_T DataStoreRead3_b;             /* '<S104>/Data Store Read3' */
  ...
  real_T DataStoreRead6_g;             /* '<S158>/Data Store Read6' */
  real_T Sum_n;                        /* '<S158>/Sum' */
  real_T r;                            /* '<S158>/r' */
  real_T Switch1;                      /* '<S158>/Switch1' */
  real_T fi;                           /* '<S158>/fi' */
  real_T Switch2;                      /* '<S158>/Switch2' */
  real_T Add2;                         /* '<S102>/Add2' */
  real_T Add1;                         /* '<S102>/Add1' */
  real_T fi1;                          /* '<S102>/fi1' */
  real_T Gain_a;                       /* '<S155>/Gain' */
  real_T fi2;                          /* '<S102>/fi2' */
  real_T Gain_n;                       /* '<S156>/Gain' */
  real_T fi3;                          /* '<S102>/fi3' */
  real_T Gain_k2;                      /* '<S157>/Gain' */
  real_T ograniczenie;                 /* '<S102>/ograniczenie' */
  real_T Add;                          /* '<S102>/Add' */
  real_T Abs_k;                        /* '<S102>/Abs' */
  real_T Switch1_h;                    /* '<S165>/Switch1' */
  real_T fi_k;                         /* '<S165>/fi' */
  real_T Gain_l[2];                    /* '<S165>/Gain' */
  real_T Xgran;                        /* '<S174>/Xgran' */
  real_T Xgran1;                       /* '<S174>/Xgran1' */
  real_T Gain_d;                       /* '<S174>/Gain' */
  real_T DataStoreRead6_i;             /* '<S172>/Data Store Read6' */
  real_T Add_l;                        /* '<S172>/Add' */
  real_T Xgran_d;                      /* '<S173>/Xgran' */
  real_T Xgran1_o;                     /* '<S173>/Xgran1' */
  real_T Gain_m;                       /* '<S173>/Gain' */
  real_T DataStoreRead6_o;             /* '<S175>/Data Store Read6' */
  real_T Add_m;                        /* '<S175>/Add' */
  real_T Switch4;                      /* '<S165>/Switch4' */
  real_T Switch6;                      /* '<S165>/Switch6' */
  real_T Switch5;                      /* '<S165>/Switch5' */
  real_T Switch2_d;                    /* '<S165>/Switch2' */
  real_T Switch1_n;                    /* '<S164>/Switch1' */
  real_T Xgran_g;                      /* '<S164>/Xgran' */
  real_T Xnastawy2;                    /* '<S164>/Xnastawy2' */
  real_T DataStoreRead6_c;             /* '<S166>/Data Store Read6' */
  real_T Add_h;                        /* '<S166>/Add' */
  real_T Xnastawy1;                    /* '<S164>/Xnastawy1' */
  real_T DataStoreRead6_k;             /* '<S167>/Data Store Read6' */
  real_T Add_k;                        /* '<S167>/Add' */
  real_T Switch4_o;                    /* '<S164>/Switch4' */
  real_T Switch5_e;                    /* '<S164>/Switch5' */
  real_T Switch5_a;                    /* '<S158>/Switch5' */
  real_T Switch3;                      /* '<S158>/Switch3' */
  real_T Switch4_a;                    /* '<S158>/Switch4' */
  real_T Switch6_i;                    /* '<S158>/Switch6' */
  real_T DataStoreRead_h;              /* '<S101>/Data Store Read' */
  real_T DataStoreRead6_j;             /* '<S101>/Data Store Read6' */
  real_T DataStoreRead6_ob;            /* '<S119>/Data Store Read6' */
  real_T DataStoreRead2_k;             /* '<S101>/Data Store Read2' */
  real_T Sum_oi;                       /* '<S119>/Sum' */
  real_T DataStoreRead1_jb;            /* '<S101>/Data Store Read1' */
  real_T r_b;                          /* '<S119>/r' */
  real_T Switch1_g;                    /* '<S119>/Switch1' */
  real_T fi_n;                         /* '<S119>/fi' */
  real_T Switch2_n;                    /* '<S119>/Switch2' */
  real_T Add2_o;                       /* '<S101>/Add2' */
  real_T Add1_n;                       /* '<S101>/Add1' */
  real_T fi1_g;                        /* '<S101>/fi1' */
  real_T Gain_a0;                      /* '<S116>/Gain' */
  real_T fi2_b;                        /* '<S101>/fi2' */
  real_T Gain_m4;                      /* '<S117>/Gain' */
  ...
  real_T Switch1_na;                   /* '<S126>/Switch1' */
  real_T fi_kl;                        /* '<S126>/fi' */
  real_T Gain_jp[2];                   /* '<S126>/Gain' */
  real_T Xgran_c;                      /* '<S135>/Xgran' */
  real_T Xgran1_b;                     /* '<S135>/Xgran1' */
  real_T Gain_i;                       /* '<S135>/Gain' */
  real_T DataStoreRead6_kz;            /* '<S133>/Data Store Read6' */
  real_T Add_hm;                       /* '<S133>/Add' */
  real_T Xgran_df;                     /* '<S134>/Xgran' */
  real_T Xgran1_d;                     /* '<S134>/Xgran1' */
  real_T Gain_jk;                      /* '<S134>/Gain' */
  real_T DataStoreRead6_e;             /* '<S136>/Data Store Read6' */
  real_T Add_o;                        /* '<S136>/Add' */
  real_T Switch4_m;                    /* '<S126>/Switch4' */
  real_T Switch6_l;                    /* '<S126>/Switch6' */
  real_T Switch5_k;                    /* '<S126>/Switch5' */
  real_T Switch2_h;                    /* '<S126>/Switch2' */
  real_T Switch1_n3;                   /* '<S125>/Switch1' */
  real_T Xgran_k;                      /* '<S125>/Xgran' */
  real_T Xnastawy2_o;                  /* '<S125>/Xnastawy2' */
  real_T DataStoreRead6_d;             /* '<S127>/Data Store Read6' */
  real_T Add_oq;                       /* '<S127>/Add' */
  real_T Xnastawy1_n;                  /* '<S125>/Xnastawy1' */
  real_T DataStoreRead6_ky;            /* '<S128>/Data Store Read6' */
  real_T Add_cp;                       /* '<S128>/Add' */
  real_T Switch4_g;                    /* '<S125>/Switch4' */
  real_T Switch5_f;                    /* '<S125>/Switch5' */
  real_T Switch5_h;                    /* '<S119>/Switch5' */
  real_T Switch3_o;                    /* '<S119>/Switch3' */
  real_T Switch4_p;                    /* '<S119>/Switch4' */
  real_T Switch6_a;                    /* '<S119>/Switch6' */
  real_T DataStoreRead_d;              /* '<S100>/Data Store Read' */
  real_T DataStoreRead1_e;             /* '<S100>/Data Store Read1' */
  real_T DataStoreRead2_nt;            /* '<S100>/Data Store Read2' */
  real_T DataStoreRead3_d;             /* '<S100>/Data Store Read3' */
  uint8_T Compare;                     /* '<S99>/Compare' */
  uint8_T Compare_p;                   /* '<S98>/Compare' */
  uint8_T Compare_g;                   /* '<S96>/Compare' */
  uint8_T Compare_gt;                  /* '<S97>/Compare' */
  uint8_T Compare_k;                   /* '<S160>/Compare' */
  uint8_T Compare_gq;                  /* '<S161>/Compare' */
  uint8_T Compare_ku;                  /* '<S162>/Compare' */
  uint8_T Compare_f;                   /* '<S163>/Compare' */
  uint8_T Compare_c;                   /* '<S177>/Compare' */
  uint8_T Compare_b;                   /* '<S176>/Compare' */
  uint8_T Compare_h;                   /* '<S178>/Compare' */
  uint8_T Compare_n;                   /* '<S179>/Compare' */
  uint8_T Compare_d;                   /* '<S180>/Compare' */
  uint8_T Compare_fr;                  /* '<S181>/Compare' */
  uint8_T Compare_fq;                  /* '<S183>/Compare' */
  uint8_T Compare_fs;                  /* '<S182>/Compare' */
  uint8_T Compare_m;                   /* '<S169>/Compare' */
  uint8_T Compare_o;                   /* '<S168>/Compare' */
  uint8_T Compare_bq;                  /* '<S171>/Compare' */
  uint8_T Compare_fd;                  /* '<S170>/Compare' */
  uint8_T Compare_bb;                  /* '<S121>/Compare' */
  uint8_T Compare_j;                   /* '<S122>/Compare' */
  uint8_T Compare_l;                   /* '<S123>/Compare' */
  uint8_T Compare_bd;                  /* '<S124>/Compare' */
  uint8_T Compare_lx;                  /* '<S138>/Compare' */
  uint8_T Compare_i;                   /* '<S137>/Compare' */
  uint8_T Compare_a;                   /* '<S139>/Compare' */
  uint8_T Compare_f5;                  /* '<S140>/Compare' */
  uint8_T Compare_lh;                  /* '<S141>/Compare' */
  uint8_T Compare_fz;                  /* '<S142>/Compare' */
  uint8_T Compare_bv;                  /* '<S144>/Compare' */
  uint8_T Compare_ae;                  /* '<S143>/Compare' */
  uint8_T Compare_ns;                  /* '<S130>/Compare' */
  uint8_T Compare_bp;                  /* '<S129>/Compare' */
  uint8_T Compare_bm;                  /* '<S132>/Compare' */
  uint8_T Compare_im;                  /* '<S131>/Compare' */
  boolean_T Compare_jd;                /* '<S33>/Compare' */
  boolean_T Compare_e;                 /* '<S32>/Compare' */
  boolean_T LogicalOperator_a;         /* '<S24>/Logical Operator' */
  boolean_T Compare_my;                /* '<S46>/Compare' */
  boolean_T Compare_dg;                /* '<S45>/Compare' */
  boolean_T LogicalOperator_ad;        /* '<S37>/Logical Operator' */
  boolean_T Compare_pa;                /* '<S59>/Compare' */
  boolean_T Compare_cs;                /* '<S58>/Compare' */
  ...
  boolean_T LogicalOperator1;          /* '<S158>/Logical Operator1' */
  boolean_T LogicalOperator2;          /* '<S158>/Logical Operator2' */
  boolean_T LogicalOperator3;          /* '<S158>/Logical Operator3' */
  boolean_T not1;                      /* '<S158>/not1' */
  boolean_T Compare_ni;                /* '<S153>/Compare' */
  boolean_T Compare_pz;                /* '<S154>/Compare' */
  boolean_T Compare_kl;                /* '<S145>/Compare' */
  boolean_T Compare_jh;                /* '<S146>/Compare' */
  boolean_T Compare_is;                /* '<S147>/Compare' */
  boolean_T Compare_dq;                /* '<S148>/Compare' */
  boolean_T Compare_j5;                /* '<S149>/Compare' */
  boolean_T Compare_mk;                /* '<S150>/Compare' */
  boolean_T Compare_nv;                /* '<S151>/Compare' */
  boolean_T Compare_mo;                /* '<S152>/Compare' */
  boolean_T LogicalOperator_d;         /* '<S102>/Logical Operator' */
  boolean_T LogicalOperator4;          /* '<S172>/Logical Operator4' */
  boolean_T LogicalOperator1_l;        /* '<S173>/Logical Operator1' */
  boolean_T LogicalOperator1_e;        /* '<S174>/Logical Operator1' */
  boolean_T LogicalOperator4_h;        /* '<S175>/Logical Operator4' */
  boolean_T LogicalOperator4_k;        /* '<S166>/Logical Operator4' */
  boolean_T LogicalOperator4_g;        /* '<S167>/Logical Operator4' */
  boolean_T not;                       /* '<S158>/not' */
  boolean_T LogicalOperator1_eq;       /* '<S119>/Logical Operator1' */
  boolean_T LogicalOperator2_i;        /* '<S119>/Logical Operator2' */
  boolean_T LogicalOperator3_f;        /* '<S119>/Logical Operator3' */
  boolean_T not1_h;                    /* '<S119>/not1' */
  boolean_T Compare_kr;                /* '<S114>/Compare' */
  boolean_T Compare_km;                /* '<S115>/Compare' */
  boolean_T Compare_mr;                /* '<S106>/Compare' */
  boolean_T Compare_fra;               /* '<S107>/Compare' */
  boolean_T Compare_jp;                /* '<S108>/Compare' */
  boolean_T Compare_b4;                /* '<S109>/Compare' */
  ...
  boolean_T LogicalOperator4_p;        /* '<S133>/Logical Operator4' */
  boolean_T LogicalOperator1_j;        /* '<S134>/Logical Operator1' */
  boolean_T LogicalOperator1_m;        /* '<S135>/Logical Operator1' */
  boolean_T LogicalOperator4_a;        /* '<S136>/Logical Operator4' */
  boolean_T LogicalOperator4_j;        /* '<S127>/Logical Operator4' */
  boolean_T LogicalOperator4_k5;       /* '<S128>/Logical Operator4' */
  boolean_T not_o;                     /* '<S119>/not' */
} BlockIO_proba1;
...
typedef struct {
  ...
  real_T Rmax;                         /* '<Root>/Rmax' */
  real_T Rmin;                         /* '<Root>/Rmin' */
  ...
  int_T trybkinematykiodwrotnej_MODE;  /* '<S4>/tryb kinematyki odwrotnej' */
...
typedef struct {
  ...
  ZCSigState trybkinematykiodwrotnej_Trig_ZC;/* '<S4>/tryb kinematyki odwrotnej' */
...
struct Parameters_proba1 {
  ...
  real_T Constant_Value_ob;            /* Expression: const
                                        * '<S97>/Constant'
                                        */
  real_T Rmax_InitialValue;            /* Expression: 0
                                        * '<Root>/Rmax'
                                        */
  real_T Rmin_InitialValue;            /* Expression: 0
                                        * '<Root>/Rmin'
                                        */
  ...
  real_T obliczoneZ_InitialValue;      /* Expression: 0
                                        * '<Root>/obliczoneZ'
                                        */
  real_T ready_InitialValue;           /* Expression: 0
                                        * '<Root>/ready'
                                        */
  ...
  real_T _Value;                       /* Expression: 0
                                        * '<S119>/ '
                                        */
  real_T Constant_Value_i4n;           /* Expression: const
                                        * '<S123>/Constant'
                                        */
  ...
  real_T Constant1_Value_c;            /* Expression: 1
                                        * '<S158>/Constant1'
                                        */
  real_T nieosiagalna_Value_p;         /* Expression: 0
                                        * '<S164>/nieosiagalna'
                                        */
  real_T FImin1_Value_h;               /* Expression: -8*pi()/9
                                        * '<S164>/FImin1'
                                        */
  real_T FImax_Value_m;                /* Expression: 8*pi()/9
                                        * '<S164>/FImax'
                                        */
  real_T Constant_Value_ec;            /* Expression: const
                                        * '<S169>/Constant'
                                        */
  real_T Constant_Value_f4;            /* Expression: const
                                        * '<S168>/Constant'
                                        */
  real_T Constant_Value_pd;            /* Expression: const
                                        * '<S171>/Constant'
                                        */
  real_T Constant_Value_d0;            /* Expression: const
                                        * '<S170>/Constant'
                                        */
  real_T nieosiagalna1_Value_k;        /* Expression: 0
                                        * '<S165>/nieosiagalna1'
                                        */
  real_T nieosiagalna_Value_l;         /* Expression: 0
                                        * '<S165>/nieosiagalna'
                                        */
  real_T Rmax_Value_f;                 /* Expression: Rmax
                                        * '<S165>/Rmax'
                                        */
  real_T Rmin_Value_f;                 /* Expression: Rmin
                                        * '<S165>/Rmin'
                                        */
  real_T Gain_Gain_kh;                 /* Expression: -1
                                        * '<S165>/Gain'
                                        */
  ...
  real_T Constant_Value_co;            /* Expression: const
                                        * '<S177>/Constant'
                                        */
  real_T Constant_Value_bs;            /* Expression: const
                                        * '<S176>/Constant'
                                        */
  real_T Gain_Gain_fr;                 /* Expression: -1
                                        * '<S173>/Gain'
                                        */
  real_T Constant_Value_be;            /* Expression: const
                                        * '<S178>/Constant'
                                        */
  real_T Constant_Value_bn;            /* Expression: const
                                        * '<S179>/Constant'
                                        */
  real_T Constant_Value_eg;            /* Expression: const
                                        * '<S180>/Constant'
                                        */
  ...
  real_T Constant_Value_bt;            /* Expression: const
                                        * '<S183>/Constant'
                                        */
  real_T Constant_Value_lw;            /* Expression: const
                                        * '<S182>/Constant'
                                        */
  ...
  real_T Constant_Value_oq;            /* Expression: const
                                        * '<S160>/Constant'
                                        */
  real_T Constant_Value_mk;            /* Expression: const
                                        * '<S161>/Constant'
                                        */
  real_T Constant_Value_m1;            /* Expression: const
                                        * '<S162>/Constant'
                                        */
  real_T Constant_Value_gh;            /* Expression: const
                                        * '<S163>/Constant'
                                        */
  real_T Gain_Gain_l0;                 /* Expression: 180/pi
                                        * '<S155>/Gain'
                                        */
  ...
  real_T Gain_Gain_kc;                 /* Expression: 180/pi
                                        * '<S157>/Gain'
                                        */
  real_T Constant_Value_jt;            /* Expression: const
                                        * '<S153>/Constant'
                                        */
  real_T Constant_Value_kd;            /* Expression: const
                                        * '<S154>/Constant'
                                        */
  real_T Constant_Value_l2;            /* Expression: const
                                        * '<S145>/Constant'
                                        */
  real_T Constant_Value_al;            /* Expression: const
                                        * '<S146>/Constant'
                                        */
  real_T Constant_Value_dg1;           /* Expression: const
                                        * '<S147>/Constant'
                                        */
  real_T Constant_Value_on0;           /* Expression: const
                                        * '<S148>/Constant'
                                        */
  ...
  real_T Constant_Value_hi;            /* Expression: const
                                        * '<S150>/Constant'
                                        */
  real_T Constant_Value_lv;            /* Expression: const
                                        * '<S151>/Constant'
                                        */
 ...
 * '<S114>' : proba1/tryby/kinematyka odwrotna/Compare To Constant8
 * '<S115>' : proba1/tryby/kinematyka odwrotna/Compare To Constant9
 * '<S116>' : proba1/tryby/kinematyka odwrotna/Radians to Degrees
 * '<S117>' : proba1/tryby/kinematyka odwrotna/Radians to Degrees1
 * '<S118>' : proba1/tryby/kinematyka odwrotna/Radians to Degrees2
 * '<S119>' : proba1/tryby/kinematyka odwrotna/optymalizacja1
 * '<S120>' : proba1/tryby/kinematyka odwrotna/podaj wyliczone wartosci
 * '<S121>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/do Fimax
 * '<S122>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/do Fimin
 * '<S123>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/do Rmax
 * '<S124>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/do Rmin
 * '<S125>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na Fi
 * '<S126>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R
 * '<S127>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na Fi/Subsystem1
 * '<S128>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na Fi/Subsystem4
 * '<S129>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na Fi/Subsystem1/do Xmax
 * '<S130>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na Fi/Subsystem1/do Xmin
 * '<S131>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na Fi/Subsystem4/do Xmax
 * '<S132>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na Fi/Subsystem4/do Xmin
 * '<S133>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem1
 * '<S134>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem2
 * '<S135>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem3
 * '<S136>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem4
 * '<S137>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem1/do Xmax
 * '<S138>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem1/do Xmin
 * '<S139>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem2/do Fimax
 * '<S140>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem2/do Fimin
 * '<S141>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem3/do Fimax
 * '<S142>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem3/do Fimin
 * '<S143>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem4/do Xmax
 * '<S144>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem4/do Xmin
 * '<S145>' : proba1/tryby/rozpoznawanie obrazu/Compare To Constant
 * '<S146>' : proba1/tryby/rozpoznawanie obrazu/Compare To Constant1
 * '<S147>' : proba1/tryby/rozpoznawanie obrazu/Compare To Constant2
 * '<S148>' : proba1/tryby/rozpoznawanie obrazu/Compare To Constant3
 * '<S149>' : proba1/tryby/rozpoznawanie obrazu/Compare To Constant4
 * '<S150>' : proba1/tryby/rozpoznawanie obrazu/Compare To Constant5
 * '<S151>' : proba1/tryby/rozpoznawanie obrazu/Compare To Constant6
 * '<S152>' : proba1/tryby/rozpoznawanie obrazu/Compare To Constant7
 * '<S153>' : proba1/tryby/rozpoznawanie obrazu/Compare To Constant8
 * '<S154>' : proba1/tryby/rozpoznawanie obrazu/Compare To Constant9
 * '<S155>' : proba1/tryby/rozpoznawanie obrazu/Radians to Degrees
 * '<S156>' : proba1/tryby/rozpoznawanie obrazu/Radians to Degrees1
 * '<S157>' : proba1/tryby/rozpoznawanie obrazu/Radians to Degrees2
 * '<S158>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1
 * '<S159>' : proba1/tryby/rozpoznawanie obrazu/podaj wyliczone wartosci
 * '<S160>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/do Fimax
 * '<S161>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/do Fimin
 * '<S162>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/do Rmax
 * '<S163>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/do Rmin
 * '<S164>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na Fi
 * '<S165>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na R
 * '<S166>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na Fi/Subsystem1
 * '<S167>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na Fi/Subsystem4
 * '<S168>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na Fi/Subsystem1/do Xmax
 * '<S169>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na Fi/Subsystem1/do Xmin
 * '<S170>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na Fi/Subsystem4/do Xmax
 * '<S171>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na Fi/Subsystem4/do Xmin
 * '<S172>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na R/Subsystem1
 * '<S173>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na R/Subsystem2
 * '<S174>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na R/Subsystem3
 * '<S175>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na R/Subsystem4
 * '<S176>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na R/Subsystem1/do Xmax
 * '<S177>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na R/Subsystem1/do Xmin
 * '<S178>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na R/Subsystem2/do Fimax
 * '<S179>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na R/Subsystem2/do Fimin
 * '<S180>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na R/Subsystem3/do Fimax
 * '<S181>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na R/Subsystem3/do Fimin
 * '<S182>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na R/Subsystem4/do Xmax
 * '<S183>' : proba1/tryby/rozpoznawanie obrazu/optymalizacja1/warunek na R/Subsystem4/do Xmin
 */
