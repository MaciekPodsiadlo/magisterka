...
typedef struct {
  ...
  real_T DataStoreRead_p;              /* '<S106>/Data Store Read' */
  real_T DataStoreRead1_an;            /* '<S106>/Data Store Read1' */
  real_T DataStoreRead2;               /* '<S106>/Data Store Read2' */
  real_T DataStoreRead3;               /* '<S106>/Data Store Read3' */
  real_T DataStoreRead4;               /* '<S106>/Data Store Read4' */
  real_T DataStoreRead5;               /* '<S106>/Data Store Read5' */
  real_T DataStoreRead_j;              /* '<S104>/Data Store Read' */
  real_T DataStoreRead1_n;             /* '<S104>/Data Store Read1' */
  real_T DataStoreRead2_c;             /* '<S104>/Data Store Read2' */
  real_T DataStoreRead3_n;             /* '<S104>/Data Store Read3' */
  real_T DataStoreRead4_a;             /* '<S104>/Data Store Read4' */
  real_T DataStoreRead5_n;             /* '<S104>/Data Store Read5' */
  real_T wlacz;                        /* '<S103>/wlacz' */
  real_T DataStoreRead3_j;             /* '<S102>/Data Store Read3' */
  real_T DataStoreRead6;               /* '<S102>/Data Store Read6' */
  real_T DataStoreRead6_k;             /* '<S159>/Data Store Read6' */
  real_T DataStoreRead5_o;             /* '<S102>/Data Store Read5' */
  real_T Sum_e;                        /* '<S159>/Sum' */
  real_T DataStoreRead4_p;             /* '<S102>/Data Store Read4' */
  real_T r;                            /* '<S159>/r' */
  real_T Switch1;                      /* '<S159>/Switch1' */
  real_T fi;                           /* '<S159>/fi' */
  real_T Switch2;                      /* '<S159>/Switch2' */
  real_T Add2;                         /* '<S102>/Add2' */
  real_T Add1;                         /* '<S102>/Add1' */
  real_T fi1;                          /* '<S102>/fi1' */
  real_T Gain_i;                       /* '<S156>/Gain' */
  real_T fi2;                          /* '<S102>/fi2' */
  real_T Gain_i1;                      /* '<S157>/Gain' */
  real_T fi3;                          /* '<S102>/fi3' */
  real_T Gain_g;                       /* '<S158>/Gain' */
  real_T ograniczenie;                 /* '<S102>/ograniczenie' */
  real_T Add;                          /* '<S102>/Add' */
  real_T Abs_i;                        /* '<S102>/Abs' */
  real_T Switch1_j;                    /* '<S166>/Switch1' */
  real_T fi_i;                         /* '<S166>/fi' */
  real_T Gain_m[2];                    /* '<S166>/Gain' */
  real_T Xgran;                        /* '<S175>/Xgran' */
  real_T Xgran1;                       /* '<S175>/Xgran1' */
  real_T Gain_a;                       /* '<S175>/Gain' */
  real_T DataStoreRead6_j;             /* '<S173>/Data Store Read6' */
  real_T Add_m;                        /* '<S173>/Add' */
  real_T Xgran_k;                      /* '<S174>/Xgran' */
  real_T Xgran1_g;                     /* '<S174>/Xgran1' */
  real_T Gain_ed;                      /* '<S174>/Gain' */
  real_T DataStoreRead6_l;             /* '<S176>/Data Store Read6' */
  real_T Add_j;                        /* '<S176>/Add' */
  real_T Switch4;                      /* '<S166>/Switch4' */
  real_T Switch6;                      /* '<S166>/Switch6' */
  real_T Switch5;                      /* '<S166>/Switch5' */
  real_T Switch2_a;                    /* '<S166>/Switch2' */
  real_T Switch1_n;                    /* '<S165>/Switch1' */
  real_T Xgran_f;                      /* '<S165>/Xgran' */
  real_T Xnastawy2;                    /* '<S165>/Xnastawy2' */
  real_T DataStoreRead6_m;             /* '<S167>/Data Store Read6' */
  real_T Add_k;                        /* '<S167>/Add' */
  real_T Xnastawy1;                    /* '<S165>/Xnastawy1' */
  real_T DataStoreRead6_lg;            /* '<S168>/Data Store Read6' */
  real_T Add_f;                        /* '<S168>/Add' */
  real_T Switch4_k;                    /* '<S165>/Switch4' */
  real_T Switch5_b;                    /* '<S165>/Switch5' */
  real_T Switch5_l;                    /* '<S159>/Switch5' */
  real_T Switch3;                      /* '<S159>/Switch3' */
  real_T Switch4_j;                    /* '<S159>/Switch4' */
  real_T Switch6_h;                    /* '<S159>/Switch6' */
  real_T DataStoreRead_h;              /* '<S101>/Data Store Read' */
  real_T DataStoreRead6_j5;            /* '<S101>/Data Store Read6' */
  real_T DataStoreRead6_o;             /* '<S120>/Data Store Read6' */
  real_T DataStoreRead2_k;             /* '<S101>/Data Store Read2' */
  real_T Sum_oi;                       /* '<S120>/Sum' */
  real_T DataStoreRead1_jb;            /* '<S101>/Data Store Read1' */
  real_T r_b;                          /* '<S120>/r' */
  real_T Switch1_g;                    /* '<S120>/Switch1' */
  real_T fi_n;                         /* '<S120>/fi' */
  real_T Switch2_n;                    /* '<S120>/Switch2' */
  real_T Add2_o;                       /* '<S101>/Add2' */
  real_T Add1_n;                       /* '<S101>/Add1' */
  real_T fi1_g;                        /* '<S101>/fi1' */
  real_T Gain_a0;                      /* '<S117>/Gain' */
  real_T fi2_b;                        /* '<S101>/fi2' */
  real_T Gain_m4;                      /* '<S118>/Gain' */
  real_T fi3_a;                        /* '<S101>/fi3' */
  real_T Gain_f;                       /* '<S119>/Gain' */
  real_T ograniczenie_h;               /* '<S101>/ograniczenie' */
  real_T Add_c;                        /* '<S101>/Add' */
  real_T Abs_n;                        /* '<S101>/Abs' */
  real_T Switch1_na;                   /* '<S127>/Switch1' */
  real_T fi_k;                         /* '<S127>/fi' */
  real_T Gain_jp[2];                   /* '<S127>/Gain' */
  real_T Xgran_c;                      /* '<S136>/Xgran' */
  real_T Xgran1_b;                     /* '<S136>/Xgran1' */
  real_T Gain_ik;                      /* '<S136>/Gain' */
  real_T DataStoreRead6_kz;            /* '<S134>/Data Store Read6' */
  real_T Add_h;                        /* '<S134>/Add' */
  real_T Xgran_d;                      /* '<S135>/Xgran' */
  real_T Xgran1_d;                     /* '<S135>/Xgran1' */
  real_T Gain_jk;                      /* '<S135>/Gain' */
  real_T DataStoreRead6_e;             /* '<S137>/Data Store Read6' */
  real_T Add_o;                        /* '<S137>/Add' */
  real_T Switch4_m;                    /* '<S127>/Switch4' */
  real_T Switch6_l;                    /* '<S127>/Switch6' */
  real_T Switch5_k;                    /* '<S127>/Switch5' */
  real_T Switch2_h;                    /* '<S127>/Switch2' */
  real_T Switch1_n3;                   /* '<S126>/Switch1' */
  real_T Xgran_kn;                     /* '<S126>/Xgran' */
  real_T Xnastawy2_o;                  /* '<S126>/Xnastawy2' */
  real_T DataStoreRead6_d;             /* '<S128>/Data Store Read6' */
  real_T Add_oq;                       /* '<S128>/Add' */
  real_T Xnastawy1_n;                  /* '<S126>/Xnastawy1' */
  real_T DataStoreRead6_ky;            /* '<S129>/Data Store Read6' */
  real_T Add_cp;                       /* '<S129>/Add' */
  real_T Switch4_g;                    /* '<S126>/Switch4' */
  real_T Switch5_f;                    /* '<S126>/Switch5' */
  real_T Switch5_h;                    /* '<S120>/Switch5' */
  real_T Switch3_o;                    /* '<S120>/Switch3' */
  real_T Switch4_p;                    /* '<S120>/Switch4' */
  real_T Switch6_a;                    /* '<S120>/Switch6' */
  uint8_T Compare;                     /* '<S99>/Compare' */
  uint8_T Compare_p;                   /* '<S98>/Compare' */
  uint8_T Compare_g;                   /* '<S96>/Compare' */
  uint8_T Compare_gt;                  /* '<S97>/Compare' */
  uint8_T Compare_d;                   /* '<S161>/Compare' */
  uint8_T Compare_dt;                  /* '<S162>/Compare' */
  uint8_T Compare_j;                   /* '<S163>/Compare' */
  uint8_T Compare_b;                   /* '<S164>/Compare' */
  uint8_T Compare_i;                   /* '<S178>/Compare' */
  uint8_T Compare_jq;                  /* '<S177>/Compare' */
  uint8_T Compare_j4;                  /* '<S179>/Compare' */
  uint8_T Compare_h;                   /* '<S180>/Compare' */
  uint8_T Compare_a;                   /* '<S181>/Compare' */
  uint8_T Compare_k;                   /* '<S182>/Compare' */
  uint8_T Compare_pf;                  /* '<S184>/Compare' */
  uint8_T Compare_ht;                  /* '<S183>/Compare' */
  uint8_T Compare_f;                   /* '<S170>/Compare' */
  uint8_T Compare_hb;                  /* '<S169>/Compare' */
  uint8_T Compare_gw;                  /* '<S172>/Compare' */
  uint8_T Compare_dd;                  /* '<S171>/Compare' */
  uint8_T Compare_bb;                  /* '<S122>/Compare' */
  uint8_T Compare_jz;                  /* '<S123>/Compare' */
  uint8_T Compare_l;                   /* '<S124>/Compare' */
  uint8_T Compare_bd;                  /* '<S125>/Compare' */
  uint8_T Compare_lx;                  /* '<S139>/Compare' */
  uint8_T Compare_io;                  /* '<S138>/Compare' */
  uint8_T Compare_a3;                  /* '<S140>/Compare' */
  uint8_T Compare_f5;                  /* '<S141>/Compare' */
  uint8_T Compare_lh;                  /* '<S142>/Compare' */
  uint8_T Compare_fz;                  /* '<S143>/Compare' */
  uint8_T Compare_bv;                  /* '<S145>/Compare' */
  uint8_T Compare_ae;                  /* '<S144>/Compare' */
  uint8_T Compare_n;                   /* '<S131>/Compare' */
  uint8_T Compare_bp;                  /* '<S130>/Compare' */
  uint8_T Compare_bm;                  /* '<S133>/Compare' */
  uint8_T Compare_im;                  /* '<S132>/Compare' */
  boolean_T Compare_jd;                /* '<S33>/Compare' */
  boolean_T Compare_e;                 /* '<S32>/Compare' */
  boolean_T LogicalOperator_a;         /* '<S24>/Logical Operator' */
  boolean_T Compare_m;                 /* '<S46>/Compare' */
  boolean_T Compare_dg;                /* '<S45>/Compare' */
  ...
  boolean_T Compare_as;                /* '<S71>/Compare' */
  ...
  boolean_T Compare_hw;                /* '<S95>/Compare' */
  boolean_T Compare_gk;                /* '<S94>/Compare' */
  boolean_T LogicalOperator_oc;        /* '<S89>/Logical Operator' */
  boolean_T LogicalOperator1;          /* '<S159>/Logical Operator1' */
  boolean_T LogicalOperator2;          /* '<S159>/Logical Operator2' */
  boolean_T LogicalOperator3;          /* '<S159>/Logical Operator3' */
  boolean_T not1;                      /* '<S159>/not1' */
  boolean_T Compare_ly;                /* '<S154>/Compare' */
  boolean_T Compare_fy;                /* '<S155>/Compare' */
  boolean_T Compare_mk;                /* '<S146>/Compare' */
  boolean_T Compare_kj;                /* '<S147>/Compare' */
  boolean_T Compare_i0;                /* '<S148>/Compare' */
  boolean_T Compare_o;                 /* '<S149>/Compare' */
  boolean_T Compare_fe;                /* '<S150>/Compare' */
  boolean_T Compare_j3;                /* '<S151>/Compare' */
  boolean_T Compare_mt;                /* '<S152>/Compare' */
  boolean_T Compare_fk;                /* '<S153>/Compare' */
  boolean_T LogicalOperator_m;         /* '<S102>/Logical Operator' */
  boolean_T LogicalOperator4;          /* '<S173>/Logical Operator4' */
  boolean_T LogicalOperator1_l;        /* '<S174>/Logical Operator1' */
  boolean_T LogicalOperator1_f;        /* '<S175>/Logical Operator1' */
  boolean_T LogicalOperator4_n;        /* '<S176>/Logical Operator4' */
  boolean_T LogicalOperator4_h;        /* '<S167>/Logical Operator4' */
  boolean_T LogicalOperator4_i;        /* '<S168>/Logical Operator4' */
  boolean_T not;                       /* '<S159>/not' */
  boolean_T LogicalOperator1_e;        /* '<S120>/Logical Operator1' */
  boolean_T LogicalOperator2_i;        /* '<S120>/Logical Operator2' */
  boolean_T LogicalOperator3_f;        /* '<S120>/Logical Operator3' */
  boolean_T not1_h;                    /* '<S120>/not1' */
  boolean_T Compare_kr;                /* '<S115>/Compare' */
  boolean_T Compare_km;                /* '<S116>/Compare' */
  boolean_T Compare_mr;                /* '<S107>/Compare' */
  boolean_T Compare_fr;                /* '<S108>/Compare' */
  boolean_T Compare_jp;                /* '<S109>/Compare' */
  boolean_T Compare_b4;                /* '<S110>/Compare' */
  boolean_T Compare_mp;                /* '<S111>/Compare' */
  boolean_T Compare_py;                /* '<S112>/Compare' */
  boolean_T Compare_ee;                /* '<S113>/Compare' */
  boolean_T Compare_cm;                /* '<S114>/Compare' */
  boolean_T LogicalOperator_nh;        /* '<S101>/Logical Operator' */
  boolean_T LogicalOperator4_p;        /* '<S134>/Logical Operator4' */
  boolean_T LogicalOperator1_j;        /* '<S135>/Logical Operator1' */
  boolean_T LogicalOperator1_m;        /* '<S136>/Logical Operator1' */
  boolean_T LogicalOperator4_a;        /* '<S137>/Logical Operator4' */
  boolean_T LogicalOperator4_j;        /* '<S128>/Logical Operator4' */
  boolean_T LogicalOperator4_k;        /* '<S129>/Logical Operator4' */
  boolean_T not_o;                     /* '<S120>/not' */
...
typedef struct {
  ...
  int_T kinematykaodwrotna1_MODE;      /* '<S4>/kinematyka odwrotna1' */
...
typedef struct {
  ...
  ZCSigState kinematykaodwrotna1_Trig_ZCE;/* '<S4>/kinematyka odwrotna1' */
...
struct Parameters_proba1 {
  ...
  real_T Constant_Value_hl;            /* Expression: 0
                                        * '<S93>/Constant'
                                        */
  real_T FImax_Value;                  /* Expression: 8*pi()/9
                                        * '<S126>/FImax'
                                        */
  real_T FImin1_Value;                 /* Expression: -8*pi()/9
                                        * '<S126>/FImin1'
                                        */
  real_T Constant_Value_dg;            /* Expression: const
                                        * '<S131>/Constant'
                                        */
  real_T Constant_Value_oo;            /* Expression: const
                                        * '<S130>/Constant'
                                        */
  ...
  real_T Constant_Value_it;            /* Expression: const
                                        * '<S132>/Constant'
                                        */
  real_T nieosiagalna_Value;           /* Expression: 0
                                        * '<S126>/nieosiagalna'
                                        */
  real_T Rmin_Value;                   /* Expression: Rmin
                                        * '<S127>/Rmin'
                                        */
  real_T Rmax_Value;                   /* Expression: Rmax
                                        * '<S127>/Rmax'
                                        */
  ...
  real_T Constant_Value_bb;            /* Expression: const
                                        * '<S139>/Constant'
                                        */
  real_T Constant_Value_ih;            /* Expression: const
                                        * '<S138>/Constant'
                                        */
  real_T Gain_Gain_b;                  /* Expression: -1
                                        * '<S135>/Gain'
                                        */
  real_T Constant_Value_av;            /* Expression: const
                                        * '<S140>/Constant'
                                        */
  real_T Constant_Value_k4;            /* Expression: const
                                        * '<S141>/Constant'
                                        */
  real_T Constant_Value_oh;            /* Expression: const
                                        * '<S142>/Constant'
                                        */
  real_T Constant_Value_kue;           /* Expression: const
                                        * '<S143>/Constant'
                                        */
  real_T Constant_Value_kg;            /* Expression: const
                                        * '<S145>/Constant'
                                        */
  real_T Constant_Value_m3;            /* Expression: const
                                        * '<S144>/Constant'
                                        */
  real_T nieosiagalna1_Value;          /* Expression: 0
                                        * '<S127>/nieosiagalna1'
                                        */
  real_T nieosiagalna_Value_a;         /* Expression: 0
                                        * '<S127>/nieosiagalna'
                                        */
  ...
  real_T Constant_Value_cn;            /* Expression: const
                                        * '<S122>/Constant'
                                        */
  real_T Constant_Value_kv;            /* Expression: const
                                        * '<S123>/Constant'
                                        */
  ...
  real_T Constant_Value_i4;            /* Expression: const
                                        * '<S124>/Constant'
                                        */
  real_T Constant_Value_d1;            /* Expression: const
                                        * '<S125>/Constant'
                                        */
  ...
  real_T Constant_Value_hm;            /* Expression: const
                                        * '<S115>/Constant'
                                        */
  real_T Constant_Value_aj;            /* Expression: const
                                        * '<S116>/Constant'
                                        */
  ...
  real_T Constant1_Value_pi;           /* Expression: 1
                                        * '<S159>/Constant1'
                                        */
  real_T nieosiagalna_Value_o;         /* Expression: 0
                                        * '<S165>/nieosiagalna'
                                        */
  real_T FImin1_Value_i;               /* Expression: -8*pi()/9
                                        * '<S165>/FImin1'
                                        */
  real_T FImax_Value_f;                /* Expression: 8*pi()/9
                                        * '<S165>/FImax'
                                        */
  real_T Constant_Value_de;            /* Expression: const
                                        * '<S170>/Constant'
                                        */
  real_T Constant_Value_ft;            /* Expression: const
                                        * '<S169>/Constant'
                                        */
  real_T Constant_Value_p2;            /* Expression: const
                                        * '<S172>/Constant'
                                        */
  real_T Constant_Value_go;            /* Expression: const
                                        * '<S171>/Constant'
                                        */
  real_T nieosiagalna1_Value_o;        /* Expression: 0
                                        * '<S166>/nieosiagalna1'
                                        */
  real_T nieosiagalna_Value_f;         /* Expression: 0
                                        * '<S166>/nieosiagalna'
                                        */
  real_T Rmax_Value_i;                 /* Expression: Rmax
                                        * '<S166>/Rmax'
                                        */
  real_T Rmin_Value_f;                 /* Expression: Rmin
                                        * '<S166>/Rmin'
                                        */
  ...
  real_T Constant_Value_kd;            /* Expression: const
                                        * '<S178>/Constant'
                                        */
  real_T Constant_Value_a4;            /* Expression: const
                                        * '<S177>/Constant'
                                        */
  ...
  real_T Constant_Value_da;            /* Expression: const
                                        * '<S179>/Constant'
                                        */
  real_T Constant_Value_br;            /* Expression: const
                                        * '<S180>/Constant'
                                        */
  real_T Constant_Value_ajh;           /* Expression: const
                                        * '<S181>/Constant'
                                        */
  real_T Constant_Value_cc;            /* Expression: const
                                        * '<S182>/Constant'
                                        */
  real_T Constant_Value_b0;            /* Expression: const
                                        * '<S184>/Constant'
                                        */
  real_T Constant_Value_cz;            /* Expression: const
                                        * '<S183>/Constant'
                                        */
  real_T Constant_Value_ix;            /* Expression: const
                                        * '<S161>/Constant'
                                        */
  real_T Constant_Value_ka;            /* Expression: const
                                        * '<S162>/Constant'
                                        */
  real_T Constant_Value_nx;            /* Expression: const
                                        * '<S163>/Constant'
                                        */
  real_T Constant_Value_lc;            /* Expression: const
                                        * '<S164>/Constant'
                                        */
  real_T Gain_Gain_bs;                 /* Expression: 180/pi
                                        * '<S156>/Gain'
                                        */
  ...
  real_T Constant_Value_ee;            /* Expression: const
                                        * '<S154>/Constant'
                                        */
  real_T Constant_Value_jh;            /* Expression: const
                                        * '<S155>/Constant'
                                        */
  ...
  real_T Constant_Value_iw;            /* Expression: const
                                        * '<S148>/Constant'
                                        */
  real_T Constant_Value_kvn;           /* Expression: const
                                        * '<S149>/Constant'
                                        */
  real_T Constant_Value_fr;            /* Expression: const
                                        * '<S150>/Constant'
                                        */
  real_T Constant_Value_jl;            /* Expression: const
                                        * '<S151>/Constant'
                                        */
  real_T Constant_Value_cc1;           /* Expression: const
                                        * '<S152>/Constant'
                                        */
  real_T Constant_Value_hq;            /* Expression: const
                                        * '<S153>/Constant'
                                        */
  real_T obliczoneX_Value;             /* Expression: 0
                                        * '<S103>/obliczoneX'
                                        */
  real_T obliczoneY_Value;             /* Expression: 0
                                        * '<S103>/obliczoneY'
                                        */
  real_T obliczoneZ_Value;             /* Expression: 0
                                        * '<S103>/obliczoneZ'
                                        */
  real_T wlacz_Value;                  /* Expression: 0
                                        * '<S103>/wlacz'
                                        */
};
 ...
 * '<S102>' : proba1/tryby/kinematyka odwrotna1
 * '<S103>' : proba1/tryby/rozpoznawanie obrazu
 * '<S104>' : proba1/tryby/tryb ciagly
 * '<S105>' : proba1/tryby/tryb kinematyki odwrotnej
 * '<S106>' : proba1/tryby/tryb wyzwalany
 * '<S107>' : proba1/tryby/kinematyka odwrotna/Compare To Constant
 * '<S108>' : proba1/tryby/kinematyka odwrotna/Compare To Constant1
 * '<S109>' : proba1/tryby/kinematyka odwrotna/Compare To Constant2
 * '<S110>' : proba1/tryby/kinematyka odwrotna/Compare To Constant3
 * '<S111>' : proba1/tryby/kinematyka odwrotna/Compare To Constant4
 * '<S112>' : proba1/tryby/kinematyka odwrotna/Compare To Constant5
 * '<S113>' : proba1/tryby/kinematyka odwrotna/Compare To Constant6
 * '<S114>' : proba1/tryby/kinematyka odwrotna/Compare To Constant7
 * '<S115>' : proba1/tryby/kinematyka odwrotna/Compare To Constant8
 * '<S116>' : proba1/tryby/kinematyka odwrotna/Compare To Constant9
 * '<S117>' : proba1/tryby/kinematyka odwrotna/Radians to Degrees
 * '<S118>' : proba1/tryby/kinematyka odwrotna/Radians to Degrees1
 * '<S119>' : proba1/tryby/kinematyka odwrotna/Radians to Degrees2
 * '<S120>' : proba1/tryby/kinematyka odwrotna/optymalizacja1
 * '<S121>' : proba1/tryby/kinematyka odwrotna/podaj wyliczone wartosci
 * '<S122>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/do Fimax
 * '<S123>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/do Fimin
 * '<S124>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/do Rmax
 * '<S125>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/do Rmin
 * '<S126>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na Fi
 * '<S127>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R
 * '<S128>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na Fi/Subsystem1
 * '<S129>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na Fi/Subsystem4
 * '<S130>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na Fi/Subsystem1/do Xmax
 * '<S131>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na Fi/Subsystem1/do Xmin
 * '<S132>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na Fi/Subsystem4/do Xmax
 * '<S133>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na Fi/Subsystem4/do Xmin
 * '<S134>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem1
 * '<S135>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem2
 * '<S136>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem3
 * '<S137>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem4
 * '<S138>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem1/do Xmax
 * '<S139>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem1/do Xmin
 * '<S140>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem2/do Fimax
 * '<S141>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem2/do Fimin
 * '<S142>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem3/do Fimax
 * '<S143>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem3/do Fimin
 * '<S144>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem4/do Xmax
 * '<S145>' : proba1/tryby/kinematyka odwrotna/optymalizacja1/warunek na R/Subsystem4/do Xmin
 * '<S146>' : proba1/tryby/kinematyka odwrotna1/Compare To Constant
 * '<S147>' : proba1/tryby/kinematyka odwrotna1/Compare To Constant1
 * '<S148>' : proba1/tryby/kinematyka odwrotna1/Compare To Constant2
 * '<S149>' : proba1/tryby/kinematyka odwrotna1/Compare To Constant3
 * '<S150>' : proba1/tryby/kinematyka odwrotna1/Compare To Constant4
 * '<S151>' : proba1/tryby/kinematyka odwrotna1/Compare To Constant5
 * '<S152>' : proba1/tryby/kinematyka odwrotna1/Compare To Constant6
 * '<S153>' : proba1/tryby/kinematyka odwrotna1/Compare To Constant7
 * '<S154>' : proba1/tryby/kinematyka odwrotna1/Compare To Constant8
 * '<S155>' : proba1/tryby/kinematyka odwrotna1/Compare To Constant9
 * '<S156>' : proba1/tryby/kinematyka odwrotna1/Radians to Degrees
 * '<S157>' : proba1/tryby/kinematyka odwrotna1/Radians to Degrees1
 * '<S158>' : proba1/tryby/kinematyka odwrotna1/Radians to Degrees2
 * '<S159>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1
 * '<S160>' : proba1/tryby/kinematyka odwrotna1/podaj wyliczone wartosci
 * '<S161>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/do Fimax
 * '<S162>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/do Fimin
 * '<S163>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/do Rmax
 * '<S164>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/do Rmin
 * '<S165>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na Fi
 * '<S166>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na R
 * '<S167>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na Fi/Subsystem1
 * '<S168>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na Fi/Subsystem4
 * '<S169>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na Fi/Subsystem1/do Xmax
 * '<S170>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na Fi/Subsystem1/do Xmin
 * '<S171>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na Fi/Subsystem4/do Xmax
 * '<S172>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na Fi/Subsystem4/do Xmin
 * '<S173>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na R/Subsystem1
 * '<S174>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na R/Subsystem2
 * '<S175>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na R/Subsystem3
 * '<S176>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na R/Subsystem4
 * '<S177>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na R/Subsystem1/do Xmax
 * '<S178>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na R/Subsystem1/do Xmin
 * '<S179>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na R/Subsystem2/do Fimax
 * '<S180>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na R/Subsystem2/do Fimin
 * '<S181>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na R/Subsystem3/do Fimax
 * '<S182>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na R/Subsystem3/do Fimin
 * '<S183>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na R/Subsystem4/do Xmax
 * '<S184>' : proba1/tryby/kinematyka odwrotna1/optymalizacja1/warunek na R/Subsystem4/do Xmin
 */
