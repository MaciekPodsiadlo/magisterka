/************************ dSPACE target specific file *************************
   ...
   Include file .\proba1_rti1005\proba1_th.c :

   Task Configuration file for model : proba1

   RTI1005 5.6 (16-Nov-2007)/1.4
   19-Mar-2014 12:01:16
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\proba1_rti1005\proba1_th.c is for ST).
# endif
