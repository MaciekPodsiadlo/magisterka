...
typedef struct {
  real_T DataStoreRead;                /* '<S84>/Data Store Read' */
  real_T DataStoreRead1;               /* '<S84>/Data Store Read1' */
  real_T DataStoreRead2;               /* '<S84>/Data Store Read2' */
  real_T DataStoreRead3;               /* '<S84>/Data Store Read3' */
...
typedef struct {
  ...
  real_T Memory_gz;                    /* '<S62>/Memory' */
  real_T AnalogButterworthLPFilter_k;  /* '<S63>/Analog Butterworth LP Filter' */
  real_T AnalogButterworthLPFilter1_c; /* '<S64>/Analog Butterworth LP Filter1' */
  real_T Atan2_b;                      /* '<S62>/Atan2' */
  real_T Derivative_f;                 /* '<S62>/Derivative' */
  real_T DeadZone_n;                   /* '<S62>/Dead Zone' */
  real_T Saturation_c;                 /* '<S62>/Saturation' */
  real_T Sum_c;                        /* '<S62>/Sum' */
  real_T Product_n;                    /* '<S62>/Product' */
  real_T ConversionRotationtoAngle_g;  /* '<S62>/Conversion Rotation to Angle' */
  real_T Memory1_k;                    /* '<S62>/Memory1' */
  real_T InitAngle_a;                  /* '<S62>/Init Angle' */
  real_T Sum1_d;                       /* '<S62>/Sum1' */
  real_T Gear_k;                       /* '<S62>/Gear' */
  real_T ConversionRadtoDeg_j;         /* '<S62>/Conversion Rad to Deg' */
  real_T Sum_gv;                       /* '<S17>/Sum' */
  real_T Gain_m;                       /* '<S17>/Gain' */
  real_T Saturation_m;                 /* '<S17>/Saturation' */
  real_T RateLimiter_d;                /* '<S17>/Rate Limiter' */
  real_T Gain1_c;                      /* '<S17>/Gain1' */
  real_T Memory_j5;                    /* '<S67>/Memory' */
  real_T AnalogButterworthLPFilter_c;  /* '<S68>/Analog Butterworth LP Filter' */
  real_T AnalogButterworthLPFilter1_n; /* '<S69>/Analog Butterworth LP Filter1' */
  real_T Atan2_j;                      /* '<S67>/Atan2' */
  real_T Derivative_g;                 /* '<S67>/Derivative' */
  real_T DeadZone_o;                   /* '<S67>/Dead Zone' */
  real_T Saturation_a;                 /* '<S67>/Saturation' */
  real_T Sum_mv;                       /* '<S67>/Sum' */
  real_T Product_o5;                   /* '<S67>/Product' */
  real_T ConversionRotationtoAngle_e;  /* '<S67>/Conversion Rotation to Angle' */
  real_T Memory1_fx;                   /* '<S67>/Memory1' */
  real_T InitAngle_f;                  /* '<S67>/Init Angle' */
  real_T Sum1_f;                       /* '<S67>/Sum1' */
  real_T Gear_l;                       /* '<S67>/Gear' */
  real_T ConversionRadtoDeg_h;         /* '<S67>/Conversion Rad to Deg' */
  real_T Sum_f;                        /* '<S18>/Sum' */
  real_T Gain_ev;                      /* '<S18>/Gain' */
  real_T Saturation_g;                 /* '<S18>/Saturation' */
  real_T RateLimiter_j;                /* '<S18>/Rate Limiter' */
  real_T Gain1_ps;                     /* '<S18>/Gain1' */
  real_T SFunction1_i;                 /* '<S75>/S-Function1' */
  real_T LogicalOperator_n;            /* '<S71>/Logical Operator' */
  real_T Memory_jn;                    /* '<S76>/Memory' */
  real_T Logic_he[2];                  /* '<S76>/Logic' */
  real_T DataStoreRead1_m;             /* '<S19>/Data Store Read1' */
  real_T Switch_h;                     /* '<S73>/Switch' */
  real_T Sum1_d2;                      /* '<S19>/Sum1' */
  real_T Gain_c;                       /* '<S19>/Gain' */
  real_T Saturation_i;                 /* '<S19>/Saturation' */
  real_T Product_e;                    /* '<S19>/Product' */
  ...
  real_T DataStoreRead_p;              /* '<S89>/Data Store Read' */
  real_T DataStoreRead1_a;             /* '<S89>/Data Store Read1' */
  real_T DataStoreRead2;               /* '<S89>/Data Store Read2' */
  real_T DataStoreRead3;               /* '<S89>/Data Store Read3' */
  real_T DataStoreRead_j;              /* '<S87>/Data Store Read' */
  real_T DataStoreRead1_n;             /* '<S87>/Data Store Read1' */
  real_T DataStoreRead2_c;             /* '<S87>/Data Store Read2' */
  real_T DataStoreRead3_n;             /* '<S87>/Data Store Read3' */
  real_T Uk1;                          /* '<S102>/Delay Input1' */
  real_T Uk1_o;                        /* '<S103>/Delay Input1' */
  real_T Uk1_d;                        /* '<S104>/Delay Input1' */
  real_T x_a;                          /* '<S86>/Embedded MATLAB Function' */
  real_T y_k;                          /* '<S86>/Embedded MATLAB Function' */
  real_T z_m;                          /* '<S86>/Embedded MATLAB Function' */
  real_T DataStoreRead_h;              /* '<S85>/Data Store Read' */
  real_T DataStoreRead2_k;             /* '<S85>/Data Store Read2' */
  real_T DataStoreRead1_j;             /* '<S85>/Data Store Read1' */
  real_T DataStoreRead3_a;             /* '<S85>/Data Store Read3' */
  real_T DataStoreRead5;               /* '<S85>/Data Store Read5' */
  real_T DataStoreRead4;               /* '<S85>/Data Store Read4' */
  real_T Switch_g[3];                  /* '<S85>/Switch' */
  real_T fi1;                          /* '<S85>/fi1' */
  real_T Gain_a;                       /* '<S98>/Gain' */
  real_T fi2;                          /* '<S85>/fi2' */
  real_T Gain_m4;                      /* '<S99>/Gain' */
  real_T fi3;                          /* '<S85>/fi3' */
  real_T Gain_f;                       /* '<S100>/Gain' */
  real_T ograniczenie;                 /* '<S85>/ograniczenie' */
  real_T Add;                          /* '<S85>/Add' */
  real_T Abs_n;                        /* '<S85>/Abs' */
  uint8_T Compare;                     /* '<S83>/Compare' */
  uint8_T Compare_p;                   /* '<S82>/Compare' */
  uint8_T Compare_g;                   /* '<S80>/Compare' */
  uint8_T Compare_gt;                  /* '<S81>/Compare' */
  uint8_T FixPtRelationalOperator;     /* '<S102>/FixPt Relational Operator' */
  uint8_T FixPtRelationalOperator_c;   /* '<S103>/FixPt Relational Operator' */
  uint8_T FixPtRelationalOperator_m;   /* '<S104>/FixPt Relational Operator' */
  ...
  boolean_T Compare_h;                 /* '<S79>/Compare' */
  boolean_T Compare_gk;                /* '<S78>/Compare' */
  boolean_T LogicalOperator_oc;        /* '<S73>/Logical Operator' */
  boolean_T LogicalOperator_nz;        /* '<S4>/Logical Operator' */
  boolean_T LogicalOperator_d;         /* '<S86>/Logical Operator' */
  boolean_T Compare_mr;                /* '<S90>/Compare' */
  boolean_T Compare_f;                 /* '<S91>/Compare' */
  boolean_T Compare_jp;                /* '<S92>/Compare' */
  boolean_T Compare_b;                 /* '<S93>/Compare' */
  boolean_T Compare_mp;                /* '<S94>/Compare' */
  boolean_T Compare_py;                /* '<S95>/Compare' */
  boolean_T Compare_ee;                /* '<S96>/Compare' */
  boolean_T Compare_cm;                /* '<S97>/Compare' */
  boolean_T LogicalOperator_nh;        /* '<S85>/Logical Operator' */
...
typedef struct {
  real_T DelayInput1_DSTATE;           /* '<S102>/Delay Input1' */
  real_T DelayInput1_DSTATE_g;         /* '<S103>/Delay Input1' */
  real_T DelayInput1_DSTATE_m;         /* '<S104>/Delay Input1' */
  ...
  real_T Memory1_PreviousInput_j;      /* '<S62>/Memory1' */
  real_T PrevY_l;                      /* '<S17>/Rate Limiter' */
  real_T LastMajorTime_hz;             /* '<S17>/Rate Limiter' */
  real_T Memory_PreviousInput_h;       /* '<S67>/Memory' */
  real_T Memory1_PreviousInput_n;      /* '<S67>/Memory1' */
  real_T PrevY_k;                      /* '<S18>/Rate Limiter' */
  real_T LastMajorTime_a;              /* '<S18>/Rate Limiter' */
  real_T Memory_PreviousInput_k;       /* '<S76>/Memory' */
  ...
  real_T obliczoneFi3;                 /* '<Root>/obliczoneF3' */
  ...
  struct {
    ...
    real_T TimeStampB;
    real_T LastUAtTimeB;
  } Derivative_RWORK_k;                /* '<S62>/Derivative' */
  ...
  struct {
    ...
    real_T TimeStampB;
    real_T LastUAtTimeB;
  } Derivative_RWORK_m;                /* '<S67>/Derivative' */
  ...
  int_T podajwyliczonewartosci_MODE;   /* '<S85>/podaj wyliczone wartosci' */
...
typedef struct {
  ...
  real_T AnalogButterworthLPFilter_CS_oj;/* '<S63>/Analog Butterworth LP Filter' */
  real_T AnalogButterworthLPFilter1_CS_j;/* '<S64>/Analog Butterworth LP Filter1' */
  real_T AnalogButterworthLPFilter_CST_c;/* '<S68>/Analog Butterworth LP Filter' */
  real_T AnalogButterworthLPFilter1_C_je;/* '<S69>/Analog Butterworth LP Filter1' */
...
typedef struct {
  ...
  boolean_T AnalogButterworthLPFilter_CS_oj;/* '<S63>/Analog Butterworth LP Filter' */
  boolean_T AnalogButterworthLPFilter1_CS_j;/* '<S64>/Analog Butterworth LP Filter1' */
  boolean_T AnalogButterworthLPFilter_CST_c;/* '<S68>/Analog Butterworth LP Filter' */
  boolean_T AnalogButterworthLPFilter1_C_je;/* '<S69>/Analog Butterworth LP Filter1' */
...
struct Parameters_proba1 {
  ...
  real_T ConversionRotationtoAngle_Gai_c;/* Expression: 2*pi
                                          * '<S62>/Conversion Rotation to Angle'
                                          */
  ...
  real_T Gain_Gain_n;                  /* Expression: 0.5
                                        * '<S17>/Gain'
                                        */
  real_T Saturation_UpperSat_n;        /* Expression: 3
                                        * '<S17>/Saturation'
                                        */
  real_T Saturation_LowerSat_j;        /* Expression: -3
                                        * '<S17>/Saturation'
                                        */
  ...
  real_T RateLimiter_FallingLim_e;     /* Expression: -50
                                        * '<S17>/Rate Limiter'
                                        */
  real_T Gain1_Gain_kf;                /* Expression: 0.1
                                        * '<S17>/Gain1'
                                        */
  ...
  real_T DeadZone_End_lg;              /* Expression: 5000
                                        * '<S67>/Dead Zone'
                                        */
  real_T Saturation_UpperSat_na;       /* Expression: 1
                                        * '<S67>/Saturation'
                                        */
  ...
  real_T ConversionRotationtoAngle_Gai_g;/* Expression: 2*pi
                                          * '<S67>/Conversion Rotation to Angle'
                                          */
  ...
  real_T Saturation_UpperSat_h;        /* Expression: 3
                                        * '<S18>/Saturation'
                                        */
  real_T Saturation_LowerSat_eg;       /* Expression: -3
                                        * '<S18>/Saturation'
                                        */
  real_T RateLimiter_RisingLim_g;      /* Expression: 50
                                        * '<S18>/Rate Limiter'
                                        */
  real_T RateLimiter_FallingLim_h;     /* Expression: -50
                                        * '<S18>/Rate Limiter'
                                        */
  real_T Gain1_Gain_m;                 /* Expression: 0.1
                                        * '<S18>/Gain1'
                                        */
  ...
  real_T obliczoneDist_InitialValue;   /* Expression: 0
                                        * '<Root>/obliczoneDist'
                                        */
  real_T obliczoneF3_InitialValue;     /* Expression: 0
                                        * '<Root>/obliczoneF3'
                                        */
  ...
  real_T Constant_Value_hl;            /* Expression: 0
                                        * '<S77>/Constant'
                                        */
  real_T Gain_Gain_ej;                 /* Expression: 180/pi
                                        * '<S98>/Gain'
                                        */
 ...
 * '<S61>'  : proba1/serwomechanizmy/os4/Position 4/Filters 4
 * '<S62>'  : proba1/serwomechanizmy/os4/Position 4/Position Calculation 4
 * '<S63>'  : proba1/serwomechanizmy/os4/Position 4/Filters 4/Analog Butterworth LP Filter
 * '<S64>'  : proba1/serwomechanizmy/os4/Position 4/Filters 4/Analog Butterworth LP Filter1
 * '<S65>'  : proba1/serwomechanizmy/os5/Position 5
 * '<S66>'  : proba1/serwomechanizmy/os5/Position 5/Filters 5
 * '<S67>'  : proba1/serwomechanizmy/os5/Position 5/Position Calculation 5
 * '<S68>'  : proba1/serwomechanizmy/os5/Position 5/Filters 5/Analog Butterworth LP Filter
 * '<S69>'  : proba1/serwomechanizmy/os5/Position 5/Filters 5/Analog Butterworth LP Filter1
 * '<S70>'  : proba1/serwomechanizmy/os6/DS3001ENC_RESET_B1_C1
 * '<S71>'  : proba1/serwomechanizmy/os6/blok bazowania
 * '<S72>'  : proba1/serwomechanizmy/os6/blok stopu
 * '<S73>'  : proba1/serwomechanizmy/os6/ograniczenie3
 * '<S74>'  : proba1/serwomechanizmy/os6/skalowanie
 * '<S75>'  : proba1/serwomechanizmy/os6/blok bazowania/DS2201IN_B1
 * '<S76>'  : proba1/serwomechanizmy/os6/blok bazowania/S-R Flip-Flop
 * '<S77>'  : proba1/serwomechanizmy/os6/blok bazowania/zerowanie
 * '<S78>'  : proba1/serwomechanizmy/os6/ograniczenie3/Compare To Constant
 * '<S79>'  : proba1/serwomechanizmy/os6/ograniczenie3/Compare To Constant1
 * '<S80>'  : proba1/tryby/Compare To Constant
 * '<S81>'  : proba1/tryby/Compare To Constant1
 * '<S82>'  : proba1/tryby/Compare To Constant2
 * '<S83>'  : proba1/tryby/Compare To Constant3
 * '<S84>'  : proba1/tryby/jedz do przedmiotu
 * '<S85>'  : proba1/tryby/kinematyka odwrotna
 * '<S86>'  : proba1/tryby/rozpoznawanie obrazu
 * '<S87>'  : proba1/tryby/tryb ciagly
 * '<S88>'  : proba1/tryby/tryb kinematyki odwrotnej
 * '<S89>'  : proba1/tryby/tryb wyzwalany
 * '<S90>'  : proba1/tryby/kinematyka odwrotna/Compare To Constant
 * '<S91>'  : proba1/tryby/kinematyka odwrotna/Compare To Constant1
 * '<S92>'  : proba1/tryby/kinematyka odwrotna/Compare To Constant2
 * '<S93>'  : proba1/tryby/kinematyka odwrotna/Compare To Constant3
 * '<S94>'  : proba1/tryby/kinematyka odwrotna/Compare To Constant4
 * '<S95>'  : proba1/tryby/kinematyka odwrotna/Compare To Constant5
 * '<S96>'  : proba1/tryby/kinematyka odwrotna/Compare To Constant6
 * '<S97>'  : proba1/tryby/kinematyka odwrotna/Compare To Constant7
 * '<S98>'  : proba1/tryby/kinematyka odwrotna/Radians to Degrees
 * '<S99>'  : proba1/tryby/kinematyka odwrotna/Radians to Degrees1
 * '<S100>' : proba1/tryby/kinematyka odwrotna/Radians to Degrees2
 * '<S101>' : proba1/tryby/kinematyka odwrotna/podaj wyliczone wartosci
 * '<S102>' : proba1/tryby/rozpoznawanie obrazu/Detect Change
 * '<S103>' : proba1/tryby/rozpoznawanie obrazu/Detect Change1
 * '<S104>' : proba1/tryby/rozpoznawanie obrazu/Detect Change2
 * '<S105>' : proba1/tryby/rozpoznawanie obrazu/Embedded MATLAB Function
 * '<S106>' : proba1/tryby/rozpoznawanie obrazu/podaj wyliczone wartosci
 */
