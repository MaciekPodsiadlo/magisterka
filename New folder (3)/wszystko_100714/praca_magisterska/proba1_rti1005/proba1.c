...
void proba1_output(int_T tid)
{
...

  {
     ...
     */
    proba1_B.Compare_a = (proba1_B.DataStoreRead1_a <= proba1_P.Constant_Value_k);

    /* Logic: '<S63>/Logical Operator' */
    proba1_B.LogicalOperator_h = (proba1_B.Compare_ds && proba1_B.Compare_a);
    ...
    if (rtmIsMajorTimeStep(proba1_M) &&
      ...
      if (proba1_B.Compare > 0U) {
        ...
        if (rtmIsMajorTimeStep(proba1_M) && (rt_ZCFcn(RISING_ZERO_CROSSING,
          ...
          /* Embedded MATLAB Block: '<S102>/Embedded MATLAB Function'
           */
          /*  This block supports the Embedded MATLAB subset. */
          /*  See the help menu for details.  */
          proba1_B.x_a = 700.0 + proba1_P.Constant1_Value_m;
          proba1_B.y_k = 200.0 + proba1_P.Constant1_Value_m;
          proba1_B.z_m = 1100.0 + proba1_P.Constant1_Value_m;

          /* DataStoreWrite: '<S102>/Data Store Write' */
          proba1_DWork.zadaneX = proba1_B.x_a;

          /* DataStoreWrite: '<S102>/Data Store Write1' */
          proba1_DWork.zadaneY = proba1_B.y_k;

          /* DataStoreWrite: '<S102>/Data Store Write2' */
          proba1_DWork.zadaneZ = proba1_B.z_m;

          /* DataStoreWrite: '<S102>/Data Store Write3' incorporates:
           *  Constant: '<S102>/Constant'
           */
          proba1_DWork.A = proba1_P.Constant_Value_gi;

          /* Outputs for atomic SubSystem: '<S102>/podaj wyliczone wartosci' */
          ...
          /* DataStoreWrite: '<S122>/Data Store Write2' */
          ...
          /* RelationalOperator: '<S120>/FixPt Relational Operator' */
          ...
          /* Update for UnitDelay: '<S120>/Delay Input1' */
    ...
    if (proba1_DWork.kinematykaodwrotna_MODE == SUBSYS_ENABLED) {
      ...
      /* DataStoreRead: '<S101>/Data Store Read5' */
      proba1_B.DataStoreRead5_p = proba1_DWork.ObliczoneY;

      /* DataStoreRead: '<S101>/Data Store Read4' */
      proba1_B.DataStoreRead4_i = proba1_DWork.ObliczoneZ;
      ...
      if (proba1_B.Compare_p != 0U) {
        ...
        tmp_0 = proba1_B.DataStoreRead5_p;
        tmp_1 = proba1_B.DataStoreRead4_i;
        proba1_B.Switch_g[0] = tmp;
        proba1_B.Switch_g[1] = tmp_0;
        proba1_B.Switch_g[2] = tmp_1;
      }
      ...
      /* Gain: '<S114>/Gain' */
      proba1_B.Gain_a = proba1_P.Gain_Gain_e * proba1_B.fi1;
      ...
      /* Gain: '<S115>/Gain' */
      proba1_B.Gain_m = proba1_P.Gain_Gain_a * proba1_B.fi2;
       ...
       */
      proba1_B.Compare_mr = (proba1_B.ograniczenie <= proba1_P.Constant_Value_kq);
       ...
       */
      proba1_B.Compare_b = (proba1_B.Gain_m >= proba1_P.Constant_Value_ky);

      /* RelationalOperator: '<S110>/Compare' incorporates:
       *  Constant: '<S110>/Constant'
       */
      proba1_B.Compare_mp = (proba1_B.Gain_m <= proba1_P.Constant_Value_iz);
      ...
      /* Sum: '<S101>/Add' */
      proba1_B.Add = proba1_B.Gain_m - proba1_B.Gain_f;
      ...
      if (proba1_DWork.podajwyliczonewartosci_MODE == SUBSYS_ENABLED) {
        ...
        proba1_DWork.obliczoneFi2 = proba1_B.Gain_m;
...
void MdlInitializeSizes(void)
{
  ...
  proba1_M->Sizes.numBlocks = (421);   /* Number of blocks */
  proba1_M->Sizes.numBlockIO = (258);  /* Number of block outputs */
  proba1_M->Sizes.numBlockPrms = (306);/* Sum of parameter "widths" */
}
...
void MdlStart(void)
{
  ...
  /* InitializeConditions for UnitDelay: '<S120>/Delay Input1' */
