...
volatile boolean_T *p_proba1_B_boolean_T_2 = &proba1_B.Compare_j;
volatile real_T *p_proba1_B_real_T_3 =
  &proba1_B.trybkinematykiodwrotnej.DataStoreRead;
volatile real_T *p_proba1_B_real_T_4 = &proba1_B.jedzdoprzedmiotu.DataStoreRead;
volatile real_T *p_proba1_P_real_T_0 = &proba1_P.Memory_X0;
volatile real_T *p_proba1_DWork_real_T_0 = &proba1_DWork.DelayInput1_DSTATE;
volatile int_T *p_proba1_DWork_int_T_2 = &proba1_DWork.zerowanie_MODE;
volatile int_T *p_proba1_DWork_int_T_3 =
  &proba1_DWork.trybkinematykiodwrotnej.jedzdoprzedmiotu_MODE;
volatile int_T *p_proba1_DWork_int_T_4 =
  &proba1_DWork.jedzdoprzedmiotu.jedzdoprzedmiotu_MODE;
